...
*As of this notice, using CHANGELOG.md is DEPRECATED. We will be using [GitHub Releases](https://github.com/pulumi/pulumi-openstack/releases) for this repository*
...
## 3.7.0 (2021-12-20)
* Upgrade to v1.46.0 of the OpenStack Terraform Provider

## 3.6.0 (2021-11-18)
* Upgrade to v1.45.0 of the OpenStack Terraform Provider
...
## 3.3.1 (2021-10-04)
* Upgrade to v1.43.1 of the OpenStack Terraform Provider
