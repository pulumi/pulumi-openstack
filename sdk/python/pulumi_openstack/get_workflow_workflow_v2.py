...
def get_workflow_workflow_v2(name: Optional[_builtins.str] = None,
    ...
    workflow1 = openstack.get_workflow_workflow_v2(name="workflow_1")
    ```


    :param _builtins.str name: The name of the workflow.
    :param _builtins.str namespace: The namespace of the workflow.
    :param _builtins.str project_id: The id of the project to retrieve the workflow.
