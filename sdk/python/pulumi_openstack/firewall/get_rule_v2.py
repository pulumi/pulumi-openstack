...
def get_rule_v2(action: Optional[str] = None,
...
@_utilities.lift_output_func(get_rule_v2)
def get_rule_v2_output(action: Optional[pulumi.Input[Optional[str]]] = None,
                       ...
                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetRuleV2Result]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
