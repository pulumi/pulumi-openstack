...
class GetRuleV2Result:
    ...
    def destination_ip_address(self) -> Optional[builtins.str]:
        """
        See Argument Reference above.
        """
    ...
    def destination_port(self) -> Optional[builtins.str]:
        """
        See Argument Reference above.
        """
    ...
    def firewall_policy_ids(self) -> Sequence[builtins.str]:
        """
...
class AwaitableGetRuleV2Result(GetRuleV2Result):
...
def get_rule_v2(action: Optional[builtins.str] = None,
                description: Optional[builtins.str] = None,
                destination_ip_address: Optional[builtins.str] = None,
                destination_port: Optional[builtins.str] = None,
                enabled: Optional[builtins.bool] = None,
                firewall_policy_ids: Optional[Sequence[builtins.str]] = None,
                ...
                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRuleV2Result:
    """
    ...
    :param builtins.str action: Action to be taken when the firewall rule matches.
    :param builtins.str description: The description of the firewall rule.
    :param builtins.str destination_ip_address: The destination IP address on which the
           firewall rule operates.
    :param builtins.str destination_port: The destination port on which the firewall
           rule operates.
    :param builtins.bool enabled: Enabled status for the firewall rule.
    :param Sequence[builtins.str] firewall_policy_ids: The ID of the firewall policy the rule belongs to.
    :param builtins.int ip_version: IP version, either 4 (default) or 6.
    :param builtins.str name: The name of the firewall rule.
    ...
    :param builtins.str protocol: The protocol type on which the firewall rule operates.
    :param builtins.str region: The region in which to obtain the V2 Neutron client.
           A Neutron client is needed to retrieve firewall policy ids. If omitted, the
           `region` argument of the provider is used.
    :param builtins.str rule_id: The ID of the firewall rule.
    :param builtins.bool shared: The sharing status of the firewall policy.
    :param builtins.str source_ip_address: The source IP address on which the firewall
           rule operates.
    :param builtins.str source_port: The source port on which the firewall
           rule operates.
    ...
    __ret__ = pulumi.runtime.invoke('openstack:firewall/getRuleV2:getRuleV2', __args__, opts=opts, typ=GetRuleV2Result).value

    return AwaitableGetRuleV2Result(
...
def get_rule_v2_output(action: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       destination_ip_address: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       destination_port: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                       firewall_policy_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                       ...
                       source_ip_address: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       source_port: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       tenant_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRuleV2Result]:
    """
    Use this data source to get information of an available OpenStack firewall rule v2.
    ...
    __ret__ = pulumi.runtime.invoke_output('openstack:firewall/getRuleV2:getRuleV2', __args__, opts=opts, typ=GetRuleV2Result)
    return __ret__.apply(lambda __response__: GetRuleV2Result(
