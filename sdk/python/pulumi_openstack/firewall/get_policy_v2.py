...
class GetPolicyV2Result:
    ...
    @_builtins.property
    @pulumi.getter
    def audited(self) -> _builtins.bool:
        """
...
def get_policy_v2(audited: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool audited: Whether this policy has been audited.
    :param _builtins.str description: Human-readable description of the policy.
    :param _builtins.str name: The name of the firewall policy.
    :param _builtins.str policy_id: The ID of the firewall policy.
    ...
    :param _builtins.bool shared: Whether this policy is shared across all projects.
...
def get_policy_v2_output(audited: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('openstack:firewall/getPolicyV2:getPolicyV2', __args__, opts=opts, typ=GetPolicyV2Result)
    return __ret__.apply(lambda __response__: GetPolicyV2Result(
