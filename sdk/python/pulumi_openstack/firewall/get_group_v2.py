...
def get_group_v2(admin_state_up: Optional[bool] = None,
...
@_utilities.lift_output_func(get_group_v2)
def get_group_v2_output(admin_state_up: Optional[pulumi.Input[Optional[bool]]] = None,
                        ...
                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGroupV2Result]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
