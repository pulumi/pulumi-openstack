...
class GetGroupV2Result:
    ...
    def admin_state_up(self) -> builtins.bool:
        """
    ...
    def egress_firewall_policy_id(self) -> Optional[builtins.str]:
        """
        See Argument Reference above.
        """
    ...
    def ingress_firewall_policy_id(self) -> Optional[builtins.str]:
        """
        See Argument Reference above.
        """
...
class AwaitableGetGroupV2Result(GetGroupV2Result):
...
def get_group_v2(admin_state_up: Optional[builtins.bool] = None,
                 description: Optional[builtins.str] = None,
                 egress_firewall_policy_id: Optional[builtins.str] = None,
                 group_id: Optional[builtins.str] = None,
                 ingress_firewall_policy_id: Optional[builtins.str] = None,
                 ...
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGroupV2Result:
    """
    ...
    :param builtins.bool admin_state_up: Administrative up/down status for the firewall group.
    :param builtins.str description: Human-readable description of the firewall group.
    :param builtins.str egress_firewall_policy_id: The egress policy ID of the firewall group.
    :param builtins.str group_id: The ID of the firewall group.
    :param builtins.str ingress_firewall_policy_id: The ingress policy ID of the firewall group.
    :param builtins.str name: The name of the firewall group.
    ...
    :param builtins.bool shared: The sharing status of the firewall group.
    :param builtins.str status: Enabled status for the firewall group.
    ...
    __ret__ = pulumi.runtime.invoke('openstack:firewall/getGroupV2:getGroupV2', __args__, opts=opts, typ=GetGroupV2Result).value

    return AwaitableGetGroupV2Result(
...
def get_group_v2_output(admin_state_up: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                        description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        egress_firewall_policy_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        ingress_firewall_policy_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        ...
                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGroupV2Result]:
    """
    Use this data source to get information of an available OpenStack firewall group v2.
    ...
    __ret__ = pulumi.runtime.invoke_output('openstack:firewall/getGroupV2:getGroupV2', __args__, opts=opts, typ=GetGroupV2Result)
    return __ret__.apply(lambda __response__: GetGroupV2Result(
