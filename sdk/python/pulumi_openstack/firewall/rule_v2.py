...
class RuleV2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action: Action to be taken (must be "allow", "deny" or "reject")
               when the firewall rule matches. Changing this updates the `action` of an
               existing firewall rule. Default is `deny`.
        :param pulumi.Input[builtins.str] description: A description for the firewall rule. Changing this
               updates the `description` of an existing firewall rule.
        :param pulumi.Input[builtins.str] destination_ip_address: The destination IP address on which the
               firewall rule operates. Changing this updates the `destination_ip_address`
               of an existing firewall rule.
        :param pulumi.Input[builtins.str] destination_port: The destination port on which the firewall
               rule operates. Changing this updates the `destination_port` of an existing
               firewall rule. Require not `any` or empty protocol.
        :param pulumi.Input[builtins.bool] enabled: Enabled status for the firewall rule (must be "true"
               or "false" if provided - defaults to "true"). Changing this updates the
               `enabled` status of an existing firewall rule.
        :param pulumi.Input[builtins.int] ip_version: IP version, either 4 or 6. Changing this
               updates the `ip_version` of an existing firewall rule. Default is `4`.
        :param pulumi.Input[builtins.str] name: A unique name for the firewall rule. Changing this
        ...
        :param pulumi.Input[builtins.str] project_id: This argument conflicts and is interchangeable
               ...
               firewall rule.
        :param pulumi.Input[builtins.str] protocol: (Optional; Required if `source_port` or `destination_port` is not
        ...
        :param pulumi.Input[builtins.str] region: The region in which to obtain the v2 networking client.
               ...
               firewall rule.
        :param pulumi.Input[builtins.bool] shared: Sharing status of the firewall rule (must be "true"
               or "false" if provided). If this is "true" the policy is visible to, and
               can be used in, firewalls in other tenants. Changing this updates the
               `shared` status of an existing firewall policy. On
        :param pulumi.Input[builtins.str] source_ip_address: The source IP address on which the firewall
               rule operates. Changing this updates the `source_ip_address` of an existing
               firewall rule.
        :param pulumi.Input[builtins.str] source_port: The source port on which the firewall
               rule operates. Changing this updates the `source_port` of an existing
               firewall rule. Require not `any` or empty protocol.
        :param pulumi.Input[builtins.str] tenant_id: This argument conflicts and is interchangeable
...
class RuleV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_ip_address: Optional[pulumi.Input[builtins.str]] = None,
            source_port: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RuleV2':
        """
