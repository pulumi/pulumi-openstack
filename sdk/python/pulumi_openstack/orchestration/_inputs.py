...
if not MYPY:
    class StackV1StackOutputArgsDict(TypedDict):
        output_key: pulumi.Input[builtins.str]
        output_value: pulumi.Input[builtins.str]
...
class StackV1StackOutputArgs:
    ...
    def output_key(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "output_key")

    @output_key.setter
    def output_key(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "output_key", value)

    @property
    @pulumi.getter(name="outputValue")
    def output_value(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "output_value")

    @output_value.setter
    def output_value(self, value: pulumi.Input[builtins.str]):
