...
class VolumeAttachArgs:
    def __init__(__self__, *,
                 ...
                 attach_mode: Optional[pulumi.Input[builtins.str]] = None,
                 device: Optional[pulumi.Input[builtins.str]] = None,
                 initiator: Optional[pulumi.Input[builtins.str]] = None,
                 ip_address: Optional[pulumi.Input[builtins.str]] = None,
                 multipath: Optional[pulumi.Input[builtins.bool]] = None,
                 os_type: Optional[pulumi.Input[builtins.str]] = None,
                 platform: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 wwnn: Optional[pulumi.Input[builtins.str]] = None,
                 wwpns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a VolumeAttach resource.
        :param pulumi.Input[builtins.str] host_name: The host to attach the volume to.
        :param pulumi.Input[builtins.str] volume_id: The ID of the Volume to attach to an Instance.
        :param pulumi.Input[builtins.str] attach_mode: Specify whether to attach the volume as Read-Only
               (`ro`) or Read-Write (`rw`). Only values of `ro` and `rw` are accepted.
               If left unspecified, the Block Storage API will apply a default of `rw`.
        :param pulumi.Input[builtins.str] device: The device to tell the Block Storage service this
               volume will be attached as. This is purely for informational purposes.
               You can specify `auto` or a device such as `/dev/vdc`.
        :param pulumi.Input[builtins.str] initiator: The iSCSI initiator string to make the connection.
        :param pulumi.Input[builtins.str] ip_address: The IP address of the `host_name` above.
        :param pulumi.Input[builtins.bool] multipath: Whether to connect to this volume via multipath.
        :param pulumi.Input[builtins.str] os_type: The iSCSI initiator OS type.
        :param pulumi.Input[builtins.str] platform: The iSCSI initiator platform.
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V3 Block Storage
               client. A Block Storage client is needed to create a volume attachment.
               If omitted, the `region` argument of the provider is used. Changing this
               creates a new volume attachment.
        :param pulumi.Input[builtins.str] wwnn: A wwnn name. Used for Fibre Channel connections.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] wwpns: An array of wwpn strings. Used for Fibre Channel
               connections.
        """
    ...
    def attach_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @attach_mode.setter
    def attach_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def multipath(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @multipath.setter
    def multipath(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def wwnn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @wwnn.setter
    def wwnn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "wwnn", value)

    @property
    @pulumi.getter
    def wwpns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @wwpns.setter
    def wwpns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _VolumeAttachState:
    def __init__(__self__, *,
                 ...
                 device: Optional[pulumi.Input[builtins.str]] = None,
                 driver_volume_type: Optional[pulumi.Input[builtins.str]] = None,
                 host_name: Optional[pulumi.Input[builtins.str]] = None,
                 initiator: Optional[pulumi.Input[builtins.str]] = None,
                 ip_address: Optional[pulumi.Input[builtins.str]] = None,
                 mount_point_base: Optional[pulumi.Input[builtins.str]] = None,
                 multipath: Optional[pulumi.Input[builtins.bool]] = None,
                 os_type: Optional[pulumi.Input[builtins.str]] = None,
                 platform: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] attach_mode: Specify whether to attach the volume as Read-Only
               (`ro`) or Read-Write (`rw`). Only values of `ro` and `rw` are accepted.
               If left unspecified, the Block Storage API will apply a default of `rw`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] data: This is a map of key/value pairs that contain the connection
               information. You will want to pass this information to a provisioner
               script to finalize the connection. See below for more information.
        :param pulumi.Input[builtins.str] device: The device to tell the Block Storage service this
               volume will be attached as. This is purely for informational purposes.
               You can specify `auto` or a device such as `/dev/vdc`.
        :param pulumi.Input[builtins.str] driver_volume_type: The storage driver that the volume is based on.
        :param pulumi.Input[builtins.str] host_name: The host to attach the volume to.
        :param pulumi.Input[builtins.str] initiator: The iSCSI initiator string to make the connection.
        :param pulumi.Input[builtins.str] ip_address: The IP address of the `host_name` above.
        :param pulumi.Input[builtins.str] mount_point_base: A mount point base name for shared storage.
        :param pulumi.Input[builtins.bool] multipath: Whether to connect to this volume via multipath.
        :param pulumi.Input[builtins.str] os_type: The iSCSI initiator OS type.
        :param pulumi.Input[builtins.str] platform: The iSCSI initiator platform.
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V3 Block Storage
    ...
    def driver_volume_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def driver_volume_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def mount_point_base(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def mount_point_base(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VolumeAttach(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            volume_id: Optional[pulumi.Input[builtins.str]] = None,
            wwnn: Optional[pulumi.Input[builtins.str]] = None,
            wwpns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'VolumeAttach':
        """
    ...
    @property
    @pulumi.getter(name="attachMode")
    def attach_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specify whether to attach the volume as Read-Only
        (`ro`) or Read-Write (`rw`). Only values of `ro` and `rw` are accepted.
        If left unspecified, the Block Storage API will apply a default of `rw`.
    ...
    @property
    @pulumi.getter(name="driverVolumeType")
    def driver_volume_type(self) -> pulumi.Output[builtins.str]:
        """
        The storage driver that the volume is based on.
        """
        return pulumi.get(self, "driver_volume_type")
    ...
    @property
    @pulumi.getter
    def initiator(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The iSCSI initiator string to make the connection.
        """
        return pulumi.get(self, "initiator")
    ...
    @property
    @pulumi.getter(name="mountPointBase")
    def mount_point_base(self) -> pulumi.Output[builtins.str]:
        """
        A mount point base name for shared storage.
        """
        return pulumi.get(self, "mount_point_base")
    ...
    @property
    @pulumi.getter
    def multipath(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to connect to this volume via multipath.
        """
        return pulumi.get(self, "multipath")
    ...
    @property
    @pulumi.getter
    def wwnn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A wwnn name. Used for Fibre Channel connections.
        """
        return pulumi.get(self, "wwnn")
    ...
    @property
    @pulumi.getter
    def wwpns(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        An array of wwpn strings. Used for Fibre Channel
        connections.
        """
