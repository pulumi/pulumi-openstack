...
class VolumeAttachArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] device: The device to tell the Block Storage service this
               volume will be attached as. This is purely for informational purposes.
               You can specify `auto` or a device such as `/dev/vdc`.
        :param pulumi.Input[_builtins.str] initiator: The iSCSI initiator string to make the connection.
        :param pulumi.Input[_builtins.str] ip_address: The IP address of the `host_name` above.
        :param pulumi.Input[_builtins.bool] multipath: Whether to connect to this volume via multipath.
        :param pulumi.Input[_builtins.str] os_type: The iSCSI initiator OS type.
        :param pulumi.Input[_builtins.str] platform: The iSCSI initiator platform.
        :param pulumi.Input[_builtins.str] region: The region in which to obtain the V3 Block Storage
               client. A Block Storage client is needed to create a volume attachment.
               If omitted, the `region` argument of the provider is used. Changing this
               creates a new volume attachment.
        :param pulumi.Input[_builtins.str] wwnn: A wwnn name. Used for Fibre Channel connections.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] wwpns: An array of wwpn strings. Used for Fibre Channel
               connections.
        """
...
class _VolumeAttachState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] attach_mode: Specify whether to attach the volume as Read-Only
               (`ro`) or Read-Write (`rw`). Only values of `ro` and `rw` are accepted.
               If left unspecified, the Block Storage API will apply a default of `rw`.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] data: This is a map of key/value pairs that contain the connection
               information. You will want to pass this information to a provisioner
               script to finalize the connection. See below for more information.
        :param pulumi.Input[_builtins.str] device: The device to tell the Block Storage service this
               volume will be attached as. This is purely for informational purposes.
               You can specify `auto` or a device such as `/dev/vdc`.
        :param pulumi.Input[_builtins.str] driver_volume_type: The storage driver that the volume is based on.
        :param pulumi.Input[_builtins.str] host_name: The host to attach the volume to.
        :param pulumi.Input[_builtins.str] initiator: The iSCSI initiator string to make the connection.
        :param pulumi.Input[_builtins.str] ip_address: The IP address of the `host_name` above.
        :param pulumi.Input[_builtins.str] mount_point_base: A mount point base name for shared storage.
        :param pulumi.Input[_builtins.bool] multipath: Whether to connect to this volume via multipath.
        :param pulumi.Input[_builtins.str] os_type: The iSCSI initiator OS type.
        :param pulumi.Input[_builtins.str] platform: The iSCSI initiator platform.
        :param pulumi.Input[_builtins.str] region: The region in which to obtain the V3 Block Storage
...
class VolumeAttach(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="attachMode")
    def attach_mode(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specify whether to attach the volume as Read-Only
        (`ro`) or Read-Write (`rw`). Only values of `ro` and `rw` are accepted.
        If left unspecified, the Block Storage API will apply a default of `rw`.
    ...
    @_builtins.property
    @pulumi.getter(name="driverVolumeType")
    def driver_volume_type(self) -> pulumi.Output[_builtins.str]:
        """
        The storage driver that the volume is based on.
        """
        return pulumi.get(self, "driver_volume_type")
    ...
    @_builtins.property
    @pulumi.getter
    def initiator(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The iSCSI initiator string to make the connection.
        """
        return pulumi.get(self, "initiator")
    ...
    @_builtins.property
    @pulumi.getter(name="mountPointBase")
    def mount_point_base(self) -> pulumi.Output[_builtins.str]:
        """
        A mount point base name for shared storage.
        """
        return pulumi.get(self, "mount_point_base")
    ...
    @_builtins.property
    @pulumi.getter
    def multipath(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Whether to connect to this volume via multipath.
        """
        return pulumi.get(self, "multipath")
    ...
    @_builtins.property
    @pulumi.getter
    def wwnn(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A wwnn name. Used for Fibre Channel connections.
        """
        return pulumi.get(self, "wwnn")
    ...
    @_builtins.property
    @pulumi.getter
    def wwpns(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        An array of wwpn strings. Used for Fibre Channel
        connections.
        """
