...
def get_snapshot_v3(most_recent: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool most_recent: Pick the most recently created snapshot if there
    ...
    :param _builtins.str volume_id: The ID of the snapshot's volume.
    """
    __args__ = dict()
