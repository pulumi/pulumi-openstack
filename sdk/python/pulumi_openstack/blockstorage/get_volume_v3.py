...
def get_volume_v3(bootable: Optional[_builtins.str] = None,
    ...
    :param _builtins.str bootable: Indicates if the volume is bootable.
    :param _builtins.str host: The OpenStack host on which the volume is located.
    :param Mapping[str, _builtins.str] metadata: Metadata key/value pairs associated with the volume.
    :param _builtins.str name: The name of the volume.
    :param _builtins.str region: The region in which to obtain the V3 Block Storage
           client. If omitted, the `region` argument of the provider is used.
    :param _builtins.str status: The status of the volume.
