...
class VolumeTypeAccessV3Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project_id: ID of the project to give access to. Changing this
               creates a new resource.
        :param pulumi.Input[builtins.str] volume_type_id: ID of the volume type to give access to. Changing
...
class VolumeTypeAccessV3(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            volume_type_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VolumeTypeAccessV3':
        """
