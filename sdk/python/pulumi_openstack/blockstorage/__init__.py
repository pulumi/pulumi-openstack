...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            ...
            elif typ == "openstack:blockstorage/volumeTypeAccessV3:VolumeTypeAccessV3":
                return VolumeTypeAccessV3(name, pulumi.ResourceOptions(urn=urn))
    ...
    pulumi.runtime.register_resource_module("openstack", "blockstorage/volumeTypeAccessV3", _module_instance)
