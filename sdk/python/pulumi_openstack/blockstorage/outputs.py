...
class VolumeSchedulerHint(dict):
    ...
    def __init__(__self__, *,
                 ...
                 local_to_instance: Optional[builtins.str] = None,
        ...
        :param Sequence[builtins.str] different_hosts: The volume should be scheduled on a 
               different host from the set of volumes specified in the list provided.
        :param builtins.str local_to_instance: An instance UUID. The volume should be 
               scheduled on the same host as the instance.
        :param builtins.str query: A conditional query that a back-end must pass in
               ...
               ```
        :param Sequence[builtins.str] same_hosts: A list of volume UUIDs. The volume should be
    ...
    def local_to_instance(self) -> Optional[builtins.str]:
        """
