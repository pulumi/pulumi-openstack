...
class NodeGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: The UUID of the V1 Container Infra cluster.
        ...
        :param pulumi.Input[builtins.int] docker_volume_size: The size (in GB) of the Docker volume.
               Changing this creates a new node group.
        :param pulumi.Input[builtins.str] flavor_id: The flavor for the nodes of the node group. Can be set
               via the `OS_MAGNUM_FLAVOR` environment variable. Changing this creates a new
               node group.
        :param pulumi.Input[builtins.str] image_id: The reference to an image that is used for nodes of the
        ...
        :param pulumi.Input[builtins.int] max_node_count: The maximum number of nodes for the node group.
        ...
        :param pulumi.Input[builtins.int] min_node_count: The minimum number of nodes for the node group.
               Changing this update the minimum number of nodes of the node group.
        :param pulumi.Input[builtins.str] name: The name of the node group. Changing this creates a new
               node group.
        :param pulumi.Input[builtins.int] node_count: The number of nodes for the node group. Changing
        ...
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V1 Container Infra
               ...
               node group.
        :param pulumi.Input[builtins.str] role: The role of nodes in the node group. Changing this
...
class _NodeGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] node_count: The number of nodes for the node group. Changing
               this update the number of nodes of the node group.
        :param pulumi.Input[builtins.str] project_id: The project of the node group. Required if admin
...
class NodeGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'NodeGroup':
        """
    ...
    @property
    @pulumi.getter(name="minNodeCount")
    def min_node_count(self) -> pulumi.Output[builtins.int]:
        """
        The minimum number of nodes for the node group.
        Changing this update the minimum number of nodes of the node group.
        """
