...
class ClusterTemplateArgs:
    def __init__(__self__, *,
                 ...
                 docker_storage_driver: Optional[pulumi.Input[builtins.str]] = None,
                 docker_volume_size: Optional[pulumi.Input[builtins.int]] = None,
                 external_network_id: Optional[pulumi.Input[builtins.str]] = None,
                 fixed_network: Optional[pulumi.Input[builtins.str]] = None,
                 fixed_subnet: Optional[pulumi.Input[builtins.str]] = None,
                 flavor: Optional[pulumi.Input[builtins.str]] = None,
                 floating_ip_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 master_flavor: Optional[pulumi.Input[builtins.str]] = None,
                 master_lb_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 network_driver: Optional[pulumi.Input[builtins.str]] = None,
                 no_proxy: Optional[pulumi.Input[builtins.str]] = None,
                 public: Optional[pulumi.Input[builtins.bool]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 registry_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] cluster_distro: The distro for the cluster (fedora-atomic,
               coreos, etc.). Changing this updates the cluster distro of the existing
               cluster template.
        :param pulumi.Input[builtins.str] dns_nameserver: Address of the DNS nameserver that is used in
               nodes of the cluster. Changing this updates the DNS nameserver of the
               existing cluster template.
        :param pulumi.Input[builtins.str] docker_storage_driver: Docker storage driver. Changing this
               updates the Docker storage driver of the existing cluster template.
        :param pulumi.Input[builtins.int] docker_volume_size: The size (in GB) of the Docker volume.
               Changing this updates the Docker volume size of the existing cluster
               template.
        :param pulumi.Input[builtins.str] external_network_id: The ID of the external network that will
               be used for the cluster. Changing this updates the external network ID of
               the existing cluster template.
        :param pulumi.Input[builtins.str] fixed_network: The fixed network that will be attached to the
               cluster. Changing this updates the fixed network of the existing cluster
               template.
        :param pulumi.Input[builtins.str] fixed_subnet: The fixed subnet that will be attached to the
               cluster. Changing this updates the fixed subnet of the existing cluster
               template.
        :param pulumi.Input[builtins.str] flavor: The flavor for the nodes of the cluster. Can be set via
               the `OS_MAGNUM_FLAVOR` environment variable. Changing this updates the
               flavor of the existing cluster template.
        :param pulumi.Input[builtins.bool] floating_ip_enabled: Indicates whether created cluster should
        ...
        :param pulumi.Input[builtins.bool] hidden: Indicates whether the ClusterTemplate is hidden or not.
               Changing this updates the hidden attribute of the existing cluster
               template.
        :param pulumi.Input[builtins.str] http_proxy: The address of a proxy for receiving all HTTP
        ...
        :param pulumi.Input[builtins.str] insecure_registry: The insecure registry URL for the cluster
               ...
               existing cluster template.
        :param pulumi.Input[builtins.str] keypair_id: The name of the Compute service SSH keypair.
               Changing this updates the keypair of the existing cluster template.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: The list of key value pairs representing additional
               properties of the cluster template. Changing this updates the labels of the
               existing cluster template.
        :param pulumi.Input[builtins.str] master_flavor: The flavor for the master nodes. Can be set via
               the `OS_MAGNUM_MASTER_FLAVOR` environment variable. Changing this updates
               the master flavor of the existing cluster template.
        :param pulumi.Input[builtins.bool] master_lb_enabled: Indicates whether created cluster should
               has a loadbalancer for master nodes or not. Changing this updates the
               attribute of the existing cluster template.
        :param pulumi.Input[builtins.str] name: The name of the cluster template. Changing this updates
               the name of the existing cluster template.
        :param pulumi.Input[builtins.str] network_driver: The name of the driver for the container
               network. Changing this updates the network driver of the existing cluster
               template.
        :param pulumi.Input[builtins.str] no_proxy: A comma-separated list of IP addresses that shouldn't
               be used in the cluster. Changing this updates the no proxy list of the
               existing cluster template.
        :param pulumi.Input[builtins.bool] public: Indicates whether cluster template should be public.
               Changing this updates the public attribute of the existing cluster
               template.
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V1 Container Infra
               client. A Container Infra client is needed to create a cluster template. If
               omitted,the `region` argument of the provider is used. Changing this
               creates a new cluster template.
        :param pulumi.Input[builtins.bool] registry_enabled: Indicates whether Docker registry is enabled
               in the cluster. Changing this updates the registry enabled attribute of the
               existing cluster template.
        :param pulumi.Input[builtins.str] server_type: The server type for the cluster template. Changing
               this updates the server type of the existing cluster template.
        :param pulumi.Input[builtins.bool] tls_disabled: Indicates whether the TLS should be disabled in
               the cluster. Changing this updates the attribute of the existing cluster.
        :param pulumi.Input[builtins.str] volume_driver: The name of the driver that is used for the
    ...
    @property
    @pulumi.getter
    def coe(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def apiserver_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def apiserver_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "apiserver_port", value)

    @property
    @pulumi.getter(name="clusterDistro")
    def cluster_distro(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cluster_distro(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cluster_distro", value)

    @property
    @pulumi.getter(name="dnsNameserver")
    def dns_nameserver(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dns_nameserver(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dns_nameserver", value)

    @property
    @pulumi.getter(name="dockerStorageDriver")
    def docker_storage_driver(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def docker_storage_driver(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "docker_storage_driver", value)

    @property
    @pulumi.getter(name="dockerVolumeSize")
    def docker_volume_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def docker_volume_size(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def fixed_network(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def fixed_network(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "fixed_network", value)

    @property
    @pulumi.getter(name="fixedSubnet")
    def fixed_subnet(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @fixed_subnet.setter
    def fixed_subnet(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def floating_ip_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def floating_ip_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def insecure_registry(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def insecure_registry(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "insecure_registry", value)

    @property
    @pulumi.getter(name="keypairId")
    def keypair_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @keypair_id.setter
    def keypair_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def master_flavor(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def master_flavor(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "master_flavor", value)

    @property
    @pulumi.getter(name="masterLbEnabled")
    def master_lb_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether created cluster should
        has a loadbalancer for master nodes or not. Changing this updates the
        attribute of the existing cluster template.
    ...
    def master_lb_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def network_driver(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def network_driver(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def registry_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def registry_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ClusterTemplateState:
    def __init__(__self__, *,
                 apiserver_port: Optional[pulumi.Input[builtins.int]] = None,
                 cluster_distro: Optional[pulumi.Input[builtins.str]] = None,
                 coe: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] no_proxy: A comma-separated list of IP addresses that shouldn't
               be used in the cluster. Changing this updates the no proxy list of the
               existing cluster template.
        :param pulumi.Input[builtins.str] project_id: The project of the cluster template. Required if
        ...
        :param pulumi.Input[builtins.bool] tls_disabled: Indicates whether the TLS should be disabled in
               the cluster. Changing this updates the attribute of the existing cluster.
        :param pulumi.Input[builtins.str] user_id: The user of the cluster template. Required if admin
    ...
    @property
    @pulumi.getter
    def coe(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Container Orchestration Engine for this cluster
        template. Changing this updates the engine of the existing cluster
        template.
    ...
    @coe.setter
    def coe(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "coe", value)
...
class ClusterTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None,
            volume_driver: Optional[pulumi.Input[builtins.str]] = None) -> 'ClusterTemplate':
        """
    ...
    @property
    @pulumi.getter(name="apiserverPort")
    def apiserver_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The API server port for the Container
        Orchestration Engine for this cluster template. Changing this updates the
        API server port of the existing cluster template.
    ...
    @property
    @pulumi.getter(name="clusterDistro")
    def cluster_distro(self) -> pulumi.Output[builtins.str]:
        """
        The distro for the cluster (fedora-atomic,
        coreos, etc.). Changing this updates the cluster distro of the existing
        cluster template.
    ...
    @property
    @pulumi.getter
    def coe(self) -> pulumi.Output[builtins.str]:
        """
        The Container Orchestration Engine for this cluster
        template. Changing this updates the engine of the existing cluster
        template.
    ...
    @property
    @pulumi.getter(name="dnsNameserver")
    def dns_nameserver(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Address of the DNS nameserver that is used in
        nodes of the cluster. Changing this updates the DNS nameserver of the
        existing cluster template.
    ...
    @property
    @pulumi.getter(name="dockerStorageDriver")
    def docker_storage_driver(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Docker storage driver. Changing this
        updates the Docker storage driver of the existing cluster template.
        """
    ...
    @property
    @pulumi.getter(name="dockerVolumeSize")
    def docker_volume_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The size (in GB) of the Docker volume.
        Changing this updates the Docker volume size of the existing cluster
        template.
    ...
    @property
    @pulumi.getter(name="externalNetworkId")
    def external_network_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the external network that will
        be used for the cluster. Changing this updates the external network ID of
        the existing cluster template.
    ...
    @property
    @pulumi.getter(name="fixedNetwork")
    def fixed_network(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The fixed network that will be attached to the
        cluster. Changing this updates the fixed network of the existing cluster
        template.
    ...
    @property
    @pulumi.getter(name="fixedSubnet")
    def fixed_subnet(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The fixed subnet that will be attached to the
        cluster. Changing this updates the fixed subnet of the existing cluster
        template.
    ...
    @property
    @pulumi.getter
    def flavor(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The flavor for the nodes of the cluster. Can be set via
        the `OS_MAGNUM_FLAVOR` environment variable. Changing this updates the
        flavor of the existing cluster template.
    ...
    @property
    @pulumi.getter(name="floatingIpEnabled")
    def floating_ip_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether created cluster should
        create floating IP for every node or not. Changing this updates the
        floating IP enabled attribute of the existing cluster template.
    ...
    @property
    @pulumi.getter(name="insecureRegistry")
    def insecure_registry(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The insecure registry URL for the cluster
        template. Changing this updates the insecure registry attribute of the
        existing cluster template.
    ...
    @property
    @pulumi.getter(name="keypairId")
    def keypair_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Compute service SSH keypair.
        Changing this updates the keypair of the existing cluster template.
        """
    ...
    @property
    @pulumi.getter(name="masterFlavor")
    def master_flavor(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The flavor for the master nodes. Can be set via
        the `OS_MAGNUM_MASTER_FLAVOR` environment variable. Changing this updates
        the master flavor of the existing cluster template.
    ...
    @property
    @pulumi.getter(name="masterLbEnabled")
    def master_lb_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether created cluster should
        has a loadbalancer for master nodes or not. Changing this updates the
        attribute of the existing cluster template.
    ...
    @property
    @pulumi.getter(name="networkDriver")
    def network_driver(self) -> pulumi.Output[builtins.str]:
        """
        The name of the driver for the container
        network. Changing this updates the network driver of the existing cluster
        template.
    ...
    @property
    @pulumi.getter
    def public(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether cluster template should be public.
        Changing this updates the public attribute of the existing cluster
        template.
    ...
    @property
    @pulumi.getter(name="registryEnabled")
    def registry_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether Docker registry is enabled
        in the cluster. Changing this updates the registry enabled attribute of the
        existing cluster template.
    ...
    @property
    @pulumi.getter(name="tlsDisabled")
    def tls_disabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the TLS should be disabled in
        the cluster. Changing this updates the attribute of the existing cluster.
        """
    ...
    @property
    @pulumi.getter(name="volumeDriver")
    def volume_driver(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the driver that is used for the
        volumes of the cluster nodes. Changing this updates the volume driver of
        the existing cluster template.
