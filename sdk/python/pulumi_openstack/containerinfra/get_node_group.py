...
def get_node_group(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_id: The name of the OpenStack Magnum cluster.
    :param builtins.str name: The name of the node group.
...
def get_node_group_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
