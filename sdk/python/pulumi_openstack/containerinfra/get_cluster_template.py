...
class GetClusterTemplateResult:
    ...
    def apiserver_port(self) -> builtins.int:
        """
    ...
    def docker_volume_size(self) -> builtins.int:
        """
    ...
    def floating_ip_enabled(self) -> builtins.bool:
        """
    ...
    def master_lb_enabled(self) -> builtins.bool:
        """
    ...
    def registry_enabled(self) -> builtins.bool:
        """
...
def get_cluster_template(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the cluster template.
    :param builtins.str region: The region in which to obtain the V1 Container Infra
           client.
...
def get_cluster_template_output(name: Optional[pulumi.Input[builtins.str]] = None,
