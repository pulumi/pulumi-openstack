...
async def get_cluster_template(name=None,region=None,opts=None):
    """
    ...
    __ret__ = await pulumi.runtime.invoke('openstack:containerinfra/getClusterTemplate:getClusterTemplate', __args__, opts=opts)
