...
class ClusterArgs:
    def __init__(__self__, *,
                 cluster_template_id: pulumi.Input[builtins.str],
                 ...
                 merge_labels: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 node_count: Optional[pulumi.Input[builtins.int]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Cluster resource.
        :param pulumi.Input[builtins.str] cluster_template_id: The UUID of the V1 Container Infra cluster
               template. Changing this creates a new cluster.
        :param pulumi.Input[builtins.int] create_timeout: The timeout (in minutes) for creating the
               cluster. Changing this creates a new cluster.
        :param pulumi.Input[builtins.str] discovery_url: The URL used for cluster node discovery.
        ...
        :param pulumi.Input[builtins.str] flavor: The flavor for the nodes of the cluster. Can be set via
               ...
               cluster.
        :param pulumi.Input[builtins.bool] floating_ip_enabled: Indicates whether floating IP should be
               created for every cluster node. Changing this creates a new cluster.
        :param pulumi.Input[builtins.str] keypair: The name of the Compute service SSH keypair. Changing
        ...
        :param pulumi.Input[builtins.int] master_count: The number of master nodes for the cluster.
               Changing this creates a new cluster.
        :param pulumi.Input[builtins.str] master_flavor: The flavor for the master nodes. Can be set via
               ...
               new cluster.
        :param pulumi.Input[builtins.bool] master_lb_enabled: Indicates whether to create a load balancer
               for the master nodes. Changing this creates a new cluster.
        :param pulumi.Input[builtins.bool] merge_labels: Indicates whether the provided labels should be
               merged with cluster template labels. Changing this creates a new cluster.
        :param pulumi.Input[builtins.str] name: The name of the cluster. Changing this creates a new
               cluster.
        :param pulumi.Input[builtins.int] node_count: The number of nodes for the cluster.
    ...
    def cluster_template_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cluster_template_id(self, value: pulumi.Input[builtins.str]):
    ...
    def merge_labels(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @merge_labels.setter
    def merge_labels(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ClusterState:
    def __init__(__self__, *,
                 api_address: Optional[pulumi.Input[builtins.str]] = None,
                 cluster_template_id: Optional[pulumi.Input[builtins.str]] = None,
                 coe_version: Optional[pulumi.Input[builtins.str]] = None,
                 container_version: Optional[pulumi.Input[builtins.str]] = None,
                 create_timeout: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 floating_ip_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 keypair: Optional[pulumi.Input[builtins.str]] = None,
                 kubeconfig: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 master_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 master_count: Optional[pulumi.Input[builtins.int]] = None,
                 master_flavor: Optional[pulumi.Input[builtins.str]] = None,
                 master_lb_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 merge_labels: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 node_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 node_count: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] name: The name of the cluster. Changing this creates a new
               cluster.
        :param pulumi.Input[builtins.int] node_count: The number of nodes for the cluster.
        :param pulumi.Input[builtins.str] project_id: The project of the cluster. Required if admin wants
        ...
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V1 Container Infra
               ...
               the `region` argument of the provider is used. Changing this creates a new
               cluster.
        :param pulumi.Input[builtins.str] user_id: The user of the cluster. Required if admin wants to
    ...
    def api_address(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "api_address")

    @api_address.setter
    def api_address(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def coe_version(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "coe_version")

    @coe_version.setter
    def coe_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "coe_version", value)

    @property
    @pulumi.getter(name="containerVersion")
    def container_version(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "container_version")

    @container_version.setter
    def container_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def kubeconfig(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "kubeconfig")

    @kubeconfig.setter
    def kubeconfig(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def master_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "master_addresses")

    @master_addresses.setter
    def master_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def node_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "node_addresses")

    @node_addresses.setter
    def node_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
@pulumi.type_token("openstack:containerinfra/cluster:Cluster")
class Cluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            stack_id: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Cluster':
        """
    ...
    @property
    @pulumi.getter(name="apiAddress")
    def api_address(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "api_address")

    @property
    @pulumi.getter(name="clusterTemplateId")
    def cluster_template_id(self) -> pulumi.Output[builtins.str]:
        """
        The UUID of the V1 Container Infra cluster
        template. Changing this creates a new cluster.
        """
    ...
    @property
    @pulumi.getter(name="coeVersion")
    def coe_version(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "coe_version")

    @property
    @pulumi.getter(name="containerVersion")
    def container_version(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "container_version")

    @property
    @pulumi.getter(name="createTimeout")
    def create_timeout(self) -> pulumi.Output[builtins.int]:
        """
        The timeout (in minutes) for creating the
        cluster. Changing this creates a new cluster.
        """
    ...
    @property
    @pulumi.getter(name="dockerVolumeSize")
    def docker_volume_size(self) -> pulumi.Output[builtins.int]:
        """
        The size (in GB) of the Docker volume.
        Changing this creates a new cluster.
        """
    ...
    @property
    @pulumi.getter(name="fixedNetwork")
    def fixed_network(self) -> pulumi.Output[builtins.str]:
        """
        The fixed network that will be attached to the
        cluster. Changing this creates a new cluster.
        """
    ...
    @property
    @pulumi.getter(name="fixedSubnet")
    def fixed_subnet(self) -> pulumi.Output[builtins.str]:
        """
        The fixed subnet that will be attached to the
        cluster. Changing this creates a new cluster.
        """
    ...
    @property
    @pulumi.getter(name="floatingIpEnabled")
    def floating_ip_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether floating IP should be
        created for every cluster node. Changing this creates a new cluster.
        """
    ...
    @property
    @pulumi.getter
    def kubeconfig(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        return pulumi.get(self, "kubeconfig")
    ...
    @property
    @pulumi.getter(name="masterAddresses")
    def master_addresses(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "master_addresses")
    ...
    @property
    @pulumi.getter(name="masterFlavor")
    def master_flavor(self) -> pulumi.Output[builtins.str]:
        """
        The flavor for the master nodes. Can be set via
        the `OS_MAGNUM_MASTER_FLAVOR` environment variable. Changing this creates a
        new cluster.
    ...
    @property
    @pulumi.getter(name="masterLbEnabled")
    def master_lb_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether to create a load balancer
        for the master nodes. Changing this creates a new cluster.
        """
    ...
    @property
    @pulumi.getter(name="mergeLabels")
    def merge_labels(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the provided labels should be
        merged with cluster template labels. Changing this creates a new cluster.
        """
    ...
    @property
    @pulumi.getter(name="nodeAddresses")
    def node_addresses(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "node_addresses")
