...
class TransferAcceptArgs:
    def __init__(__self__, *,
                 ...
                 zone_transfer_request_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] key: The transfer key.
        :param pulumi.Input[builtins.str] zone_transfer_request_id: The ID of the zone transfer request.
    ...
    def zone_transfer_request_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def zone_transfer_request_id(self, value: pulumi.Input[builtins.str]):
...
class _TransferAcceptState:
    def __init__(__self__, *,
                 ...
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 value_specs: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 zone_transfer_request_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="zoneTransferRequestId")
    def zone_transfer_request_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the zone transfer request.
        """
        return pulumi.get(self, "zone_transfer_request_id")
    ...
    @zone_transfer_request_id.setter
    def zone_transfer_request_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "zone_transfer_request_id", value)
...
class TransferAccept(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            value_specs: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            zone_transfer_request_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TransferAccept':
        """
    ...
    @property
    @pulumi.getter(name="zoneTransferRequestId")
    def zone_transfer_request_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the zone transfer request.
        """
        return pulumi.get(self, "zone_transfer_request_id")
