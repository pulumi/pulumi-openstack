...
class ZoneArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] attributes: Attributes for the DNS Service scheduler.
               Changing this creates a new zone.
        :param pulumi.Input[builtins.str] description: A description of the zone.
        :param pulumi.Input[builtins.bool] disable_status_check: Disable wait for zone to reach ACTIVE
               status. The check is enabled by default. If this argument is true, zone
               will be considered as created/updated if OpenStack request returned success.
        :param pulumi.Input[builtins.str] email: The email contact for the zone record.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] masters: An array of master DNS servers. For when `type` is
               `SECONDARY`.
        :param pulumi.Input[builtins.str] name: The name of the zone. Note the `.` at the end of the name.
...
class Zone(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ttl: Optional[pulumi.Input[builtins.int]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            value_specs: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Zone':
        """
    ...
    @property
    @pulumi.getter
    def masters(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        An array of master DNS servers. For when `type` is
        `SECONDARY`.
        """
