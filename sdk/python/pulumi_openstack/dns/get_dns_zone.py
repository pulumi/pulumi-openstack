...
class GetDnsZoneResult:
    ...
    @property
    @pulumi.getter
    def masters(self) -> Sequence[builtins.str]:
        """
...
def get_dns_zone(all_projects: Optional[builtins.str] = None,
                 attributes: Optional[Mapping[str, builtins.str]] = None,
                 created_at: Optional[builtins.str] = None,
                 description: Optional[builtins.str] = None,
                 email: Optional[builtins.str] = None,
                 masters: Optional[Sequence[builtins.str]] = None,
                 name: Optional[builtins.str] = None,
                 pool_id: Optional[builtins.str] = None,
                 project_id: Optional[builtins.str] = None,
                 region: Optional[builtins.str] = None,
                 serial: Optional[builtins.int] = None,
                 status: Optional[builtins.str] = None,
                 transferred_at: Optional[builtins.str] = None,
    ...
    :param builtins.str all_projects: Try to obtain zone ID by listing all projects
           (requires admin role by default, depends on your policy configuration)
    :param Mapping[str, builtins.str] attributes: Attributes of the DNS Service scheduler.
    :param builtins.str created_at: The time the zone was created.
    :param builtins.str description: A description of the zone.
    :param builtins.str email: The email contact for the zone record.
    :param Sequence[builtins.str] masters: An array of master DNS servers. When `type` is  `SECONDARY`.
    :param builtins.str name: The name of the zone.
    :param builtins.str pool_id: The ID of the pool hosting the zone.
    :param builtins.str project_id: The ID of the project the DNS zone is obtained from,
           sets `X-Auth-Sudo-Tenant-ID` header (requires an assigned user role in target project)
    :param builtins.str region: The region in which to obtain the V2 DNS client.
           A DNS client is needed to retrieve zone ids. If omitted, the
           `region` argument of the provider is used.
    :param builtins.int serial: The serial number of the zone.
    :param builtins.str status: The zone's status.
    :param builtins.str transferred_at: The time the zone was transferred.
    :param builtins.int ttl: The time to live (TTL) of the zone.
    :param builtins.str type: The type of the zone. Can either be `PRIMARY` or `SECONDARY`.
    :param builtins.str updated_at: The time the zone was last updated.
    :param builtins.int version: The version of the zone.
    """
    __args__ = dict()
...
def get_dns_zone_output(all_projects: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        attributes: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
                        ...
                        masters: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                        name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        pool_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        project_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        serial: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                        status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        transferred_at: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        ttl: Optional[pulumi.Input[Optional[builtins.int]]] = None,
