...
class TempUrlArgs:
    def __init__(__self__, *,
                 ...
                 regenerate: Optional[pulumi.Input[builtins.bool]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 split: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a TempUrl resource.
        :param pulumi.Input[builtins.str] container: The container name the object belongs to.
        :param pulumi.Input[builtins.str] object: The object name the tempurl is for.
        :param pulumi.Input[builtins.int] ttl: The TTL, in seconds, for the URL. For how long it should
               be valid.
        :param pulumi.Input[builtins.str] digest: The digest to use when generating the tempurl.
               Supported values are `sha1`, `sha256` and `sha512`. Default is `sha1`.
        :param pulumi.Input[builtins.str] key: The key to use when generating the tempurl. If not
               provided, the key will be read from the container or account metadata.
        :param pulumi.Input[builtins.str] method: The method allowed when accessing this URL.
               Valid values are `GET`, and `POST`. Default is `GET`.
        :param pulumi.Input[builtins.bool] regenerate: Whether to automatically regenerate the URL when
               it has expired. If set to true, this will create a new resource with a new
               ID and new URL. Defaults to false.
        :param pulumi.Input[builtins.str] region: The region the tempurl is located in.
        :param pulumi.Input[builtins.str] split: Split is the string on which to split the object URL.
               Default is `/v1/`.
        """
    ...
    @property
    @pulumi.getter
    def regenerate(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @regenerate.setter
    def regenerate(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class TempUrl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            split: Optional[pulumi.Input[builtins.str]] = None,
            ttl: Optional[pulumi.Input[builtins.int]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'TempUrl':
        """
    ...
    @property
    @pulumi.getter
    def container(self) -> pulumi.Output[builtins.str]:
        """
        The container name the object belongs to.
        """
        return pulumi.get(self, "container")
    ...
    @property
    @pulumi.getter
    def regenerate(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to automatically regenerate the URL when
        it has expired. If set to true, this will create a new resource with a new
        ID and new URL. Defaults to false.
    ...
    @property
    @pulumi.getter
    def split(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Split is the string on which to split the object URL.
        Default is `/v1/`.
        """
