...
class ContainerVersioningLegacyArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] location: Container in which versions will be stored.
        :param pulumi.Input[_builtins.str] type: Versioning type which can be `versions` or `history`
               according to [OpenStack
               documentation](https://docs.openstack.org/swift/latest/api/object_versioning.html).
        """
