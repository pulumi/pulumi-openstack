...
class AccountV1Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] project_id: The project ID of the corresponding account. If
               omitted, the token's project ID is used. Changing this creates a new account.
        :param pulumi.Input[_builtins.str] region: The region in which to create the account. If omitted,
...
class _AccountV1State:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] metadata: A map of custom key/value pairs to associate with the
               account metadata. Changing the `Quota-Bytes` key value is allowed to be
               updated only by the cloud administrator.
        :param pulumi.Input[_builtins.int] object_count: The number of objects in the account.
        :param pulumi.Input[_builtins.str] project_id: The project ID of the corresponding account. If
               omitted, the token's project ID is used. Changing this creates a new account.
        :param pulumi.Input[_builtins.int] quota_bytes: The number of bytes allowed for the account.
        :param pulumi.Input[_builtins.str] region: The region in which to create the account. If omitted,
               the `region` argument of the provider is used. Changing this creates a new
               account.
        """
...
class AccountV1(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="bytesUsed")
    def bytes_used(self) -> pulumi.Output[_builtins.int]:
        """
        The number of bytes used by the account.
        """
        return pulumi.get(self, "bytes_used")
    ...
    @_builtins.property
    @pulumi.getter(name="quotaBytes")
    def quota_bytes(self) -> pulumi.Output[_builtins.int]:
        """
        The number of bytes allowed for the account.
        """
        return pulumi.get(self, "quota_bytes")
