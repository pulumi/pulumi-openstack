...
class ImageAccessArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] status: The member proposal status. Optional if admin wants to
...
class _ImageAccessState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to obtain the V2 Glance client.
               A Glance client is needed to manage Image members. If omitted, the `region`
               argument of the provider is used. Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] schema: The member schema.
        :param pulumi.Input[_builtins.str] status: The member proposal status. Optional if admin wants to
               force the member proposal acceptance. Can either be `accepted`, `rejected` or
               `pending`. Defaults to `pending`. Foridden for non-admin users.
        :param pulumi.Input[_builtins.str] updated_at: The date the image access was last updated.
        """
...
@pulumi.type_token("openstack:images/imageAccess:ImageAccess")
class ImageAccess(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            schema: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'ImageAccess':
        """
