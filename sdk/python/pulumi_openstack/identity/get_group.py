...
def get_group(domain_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str domain_id: The domain the group belongs to.
...
def get_group_output(domain_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
