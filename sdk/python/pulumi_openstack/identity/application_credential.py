...
class ApplicationCredentialArgs:
    def __init__(__self__, *,
                 ...
                 unrestricted: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] description: A description of the application credential.
               Changing this creates a new application credential.
        :param pulumi.Input[builtins.str] expires_at: The expiration time of the application credential
               in the RFC3339 timestamp format (e.g. `2019-03-09T12:58:49Z`). If omitted,
               an application credential will never expire. Changing this creates a new
               application credential.
        :param pulumi.Input[builtins.str] name: A name of the application credential. Changing this
               creates a new application credential.
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V3 Keystone client.
               If omitted, the `region` argument of the provider is used. Changing this
               creates a new application credential.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: A collection of one or more role names, which this
               ...
               credential.
        :param pulumi.Input[builtins.str] secret: The secret for the application credential. If omitted,
               it will be generated by the server. Changing this creates a new application
               credential.
        :param pulumi.Input[builtins.bool] unrestricted: A flag indicating whether the application
    ...
    @property
    @pulumi.getter
    def unrestricted(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @unrestricted.setter
    def unrestricted(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ApplicationCredentialState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: A name of the application credential. Changing this
               creates a new application credential.
        :param pulumi.Input[builtins.str] project_id: The ID of the project the application credential was created
...
class ApplicationCredential(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            secret: Optional[pulumi.Input[builtins.str]] = None,
            unrestricted: Optional[pulumi.Input[builtins.bool]] = None) -> 'ApplicationCredential':
        """
    ...
    @property
    @pulumi.getter
    def unrestricted(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A flag indicating whether the application
        credential may be used for creation or destruction of other application
        credentials or trusts. Changing this creates a new application credential.
