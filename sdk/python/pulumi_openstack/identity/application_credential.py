...
class ApplicationCredentialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] expires_at: The expiration time of the application credential
               in the RFC3339 timestamp format (e.g. `2019-03-09T12:58:49Z`). If omitted,
               an application credential will never expire. Changing this creates a new
               application credential.
        :param pulumi.Input[_builtins.str] name: A name of the application credential. Changing this
               creates a new application credential.
        :param pulumi.Input[_builtins.str] region: The region in which to obtain the V3 Keystone client.
               If omitted, the `region` argument of the provider is used. Changing this
               creates a new application credential.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] roles: A collection of one or more role names, which this
               ...
               credential.
        :param pulumi.Input[_builtins.str] secret: The secret for the application credential. If omitted,
               it will be generated by the server. Changing this creates a new application
               credential.
        :param pulumi.Input[_builtins.bool] unrestricted: A flag indicating whether the application
...
class _ApplicationCredentialState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: A name of the application credential. Changing this
               creates a new application credential.
        :param pulumi.Input[_builtins.str] project_id: The ID of the project the application credential was created
