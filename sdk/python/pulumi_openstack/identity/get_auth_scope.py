...
class GetAuthScopeResult:
    ...
    def project_domain_id(self) -> _builtins.str:
        """
    ...
    def project_domain_name(self) -> _builtins.str:
        """
    ...
    def set_token_id(self) -> Optional[_builtins.bool]:
    ...
    def user_domain_name(self) -> _builtins.str:
        """
...
def get_auth_scope(name: Optional[_builtins.str] = None,
                   region: Optional[_builtins.str] = None,
                   set_token_id: Optional[_builtins.bool] = None,
    ...
    **Use of this data source with `set_token_id = true` in production deployments
    ...
    object_store_service = [entry for entry in scope["serviceCatalog"] if entry["type"] == "object-store"][0]
    ...
    :param _builtins.bool set_token_id: A boolean argument that determines whether to
