...
class UserMembershipV3Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group_id: The UUID of group to which the user will be added.
               Changing this creates a new user membership.
        :param pulumi.Input[builtins.str] user_id: The UUID of user to use. Changing this creates a new user membership.
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V3 Identity client.
...
class UserMembershipV3(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            group_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'UserMembershipV3':
        """
