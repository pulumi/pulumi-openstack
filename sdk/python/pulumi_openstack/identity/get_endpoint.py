...
class GetEndpointResult:
    ...
    def endpoint_region(self) -> Optional[builtins.str]:
        """
...
def get_endpoint(endpoint_region: Optional[builtins.str] = None,
    ...
    :param builtins.str endpoint_region: The region the endpoint is assigned to. The
           `region` and `endpoint_region` can be different.
    :param builtins.str interface: The endpoint interface. Valid values are `public`,
    ...
    :param builtins.str service_id: The service id this endpoint belongs to.
    :param builtins.str service_name: The service name of the endpoint.
    :param builtins.str service_type: The service type of the endpoint.
    """
    __args__ = dict()
...
def get_endpoint_output(endpoint_region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        interface: Optional[pulumi.Input[Optional[builtins.str]]] = None,
