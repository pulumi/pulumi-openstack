...
class Ec2CredentialV3Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] user_id: The ID of the user the EC2 credential is created for.
...
class _Ec2CredentialV3State:
    def __init__(__self__, *,
                 ...
                 trust_id: Optional[pulumi.Input[_builtins.str]] = None,
                 user_id: Optional[pulumi.Input[_builtins.str]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to obtain the V3 Keystone client.
               If omitted, the `region` argument of the provider is used. Changing this
               creates a new EC2 credential.
        :param pulumi.Input[_builtins.str] secret: contains an EC2 credential secret UUID
        :param pulumi.Input[_builtins.str] trust_id: contains an EC2 credential trust ID scope
        :param pulumi.Input[_builtins.str] user_id: The ID of the user the EC2 credential is created for.
               Only administrative users can specify a user ID different from the current
               auth scope.
        """
    ...
    def trust_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @trust_id.setter
    def trust_id(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class Ec2CredentialV3(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secret: Optional[pulumi.Input[_builtins.str]] = None,
            trust_id: Optional[pulumi.Input[_builtins.str]] = None,
            user_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'Ec2CredentialV3':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="trustId")
    def trust_id(self) -> pulumi.Output[_builtins.str]:
        """
        contains an EC2 credential trust ID scope
        """
        return pulumi.get(self, "trust_id")
