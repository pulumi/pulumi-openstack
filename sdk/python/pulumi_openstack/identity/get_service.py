...
def get_service(enabled: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool enabled: The service status.
    :param _builtins.str name: The service name.
    :param _builtins.str region: The region in which to obtain the V3 Keystone client.
           If omitted, the `region` argument of the provider is used.
    :param _builtins.str type: The service type.
    """
    __args__ = dict()
