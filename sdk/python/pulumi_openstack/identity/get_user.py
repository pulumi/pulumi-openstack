...
class GetUserResult:
    ...
    def password_expires_at(self) -> Optional[_builtins.str]:
        """
        See Argument Reference above.
        """
...
def get_user(domain_id: Optional[_builtins.str] = None,
             enabled: Optional[_builtins.bool] = None,
             idp_id: Optional[_builtins.str] = None,
             name: Optional[_builtins.str] = None,
             password_expires_at: Optional[_builtins.str] = None,
    ...
    :param _builtins.str domain_id: The domain this user belongs to.
    :param _builtins.bool enabled: Whether the user is enabled or disabled. Valid
           values are `true` and `false`.
    :param _builtins.str idp_id: The identity provider ID of the user.
    :param _builtins.str name: The name of the user.
    :param _builtins.str password_expires_at: Query for expired passwords. See the [OpenStack API docs](https://developer.openstack.org/api-ref/identity/v3/#list-users) for more information on the query format.
    :param _builtins.str protocol_id: The protocol ID of the user.
    :param _builtins.str region: The region in which to obtain the V3 Keystone client.
           If omitted, the `region` argument of the provider is used.
    :param _builtins.str unique_id: The unique ID of the user.
    """
    __args__ = dict()
