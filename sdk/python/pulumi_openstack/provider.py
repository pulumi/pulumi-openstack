...
class ProviderArgs:
    def __init__(__self__, *,
                 allow_reauth: Optional[pulumi.Input[builtins.bool]] = None,
                 application_credential_id: Optional[pulumi.Input[builtins.str]] = None,
                 application_credential_name: Optional[pulumi.Input[builtins.str]] = None,
                 application_credential_secret: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 delayed_auth: Optional[pulumi.Input[builtins.bool]] = None,
                 disable_no_cache_header: Optional[pulumi.Input[builtins.bool]] = None,
                 domain_id: Optional[pulumi.Input[builtins.str]] = None,
                 domain_name: Optional[pulumi.Input[builtins.str]] = None,
                 enable_logging: Optional[pulumi.Input[builtins.bool]] = None,
                 endpoint_overrides: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ...
                 project_domain_id: Optional[pulumi.Input[builtins.str]] = None,
                 project_domain_name: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 swauth: Optional[pulumi.Input[builtins.bool]] = None,
                 system_scope: Optional[pulumi.Input[builtins.bool]] = None,
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None,
                 tenant_name: Optional[pulumi.Input[builtins.str]] = None,
                 token: Optional[pulumi.Input[builtins.str]] = None,
                 user_domain_id: Optional[pulumi.Input[builtins.str]] = None,
                 user_domain_name: Optional[pulumi.Input[builtins.str]] = None,
                 user_id: Optional[pulumi.Input[builtins.str]] = None,
                 user_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Provider resource.
        :param pulumi.Input[builtins.bool] allow_reauth: If set to `false`, OpenStack authorization won't be perfomed automatically, if the initial auth token get expired.
               Defaults to `true`
        :param pulumi.Input[builtins.str] application_credential_id: Application Credential ID to login with.
        :param pulumi.Input[builtins.str] application_credential_name: Application Credential name to login with.
        :param pulumi.Input[builtins.str] application_credential_secret: Application Credential secret to login with.
        :param pulumi.Input[builtins.str] auth_url: The Identity authentication URL.
        :param pulumi.Input[builtins.str] cacert_file: A Custom CA certificate.
        :param pulumi.Input[builtins.str] cert: A client certificate to authenticate with.
        :param pulumi.Input[builtins.str] cloud: An entry in a `clouds.yaml` file to use.
        :param pulumi.Input[builtins.str] default_domain: The name of the Domain ID to scope to if no other domain is specified. Defaults to `default` (Identity v3).
        :param pulumi.Input[builtins.bool] delayed_auth: If set to `false`, OpenStack authorization will be perfomed, every time the service provider client is called. Defaults
               to `true`.
        :param pulumi.Input[builtins.bool] disable_no_cache_header: If set to `true`, the HTTP `Cache-Control: no-cache` header will not be added by default to all API requests.
        :param pulumi.Input[builtins.str] domain_id: The ID of the Domain to scope to (Identity v3).
        :param pulumi.Input[builtins.str] domain_name: The name of the Domain to scope to (Identity v3).
        :param pulumi.Input[builtins.bool] enable_logging: Outputs very verbose logs with all calls made to and responses from OpenStack
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] endpoint_overrides: A map of services with an endpoint to override what was from the Keystone catalog
        :param pulumi.Input[builtins.bool] insecure: Trust self-signed certificates.
        :param pulumi.Input[builtins.str] key: A client private key to authenticate with.
        :param pulumi.Input[builtins.int] max_retries: How many times HTTP connection should be retried until giving up.
        :param pulumi.Input[builtins.str] password: Password to login with.
        :param pulumi.Input[builtins.str] project_domain_id: The ID of the domain where the proejct resides (Identity v3).
        :param pulumi.Input[builtins.str] project_domain_name: The name of the domain where the project resides (Identity v3).
        :param pulumi.Input[builtins.str] region: The OpenStack region to connect to.
        :param pulumi.Input[builtins.bool] swauth: Use Swift's authentication system instead of Keystone. Only used for interaction with Swift.
        :param pulumi.Input[builtins.bool] system_scope: If set to `true`, system scoped authorization will be enabled. Defaults to `false` (Identity v3).
        :param pulumi.Input[builtins.str] tenant_id: The ID of the Tenant (Identity v2) or Project (Identity v3) to login with.
        :param pulumi.Input[builtins.str] tenant_name: The name of the Tenant (Identity v2) or Project (Identity v3) to login with.
        :param pulumi.Input[builtins.str] token: Authentication token to use as an alternative to username/password.
        :param pulumi.Input[builtins.str] user_domain_id: The ID of the domain where the user resides (Identity v3).
        :param pulumi.Input[builtins.str] user_domain_name: The name of the domain where the user resides (Identity v3).
        :param pulumi.Input[builtins.str] user_id: User ID to login with.
        :param pulumi.Input[builtins.str] user_name: Username to login with.
        """
    ...
    def allow_reauth(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @allow_reauth.setter
    def allow_reauth(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_reauth", value)

    @property
    @pulumi.getter(name="applicationCredentialId")
    def application_credential_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def application_credential_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "application_credential_id", value)

    @property
    @pulumi.getter(name="applicationCredentialName")
    def application_credential_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def application_credential_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "application_credential_name", value)

    @property
    @pulumi.getter(name="applicationCredentialSecret")
    def application_credential_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def application_credential_secret(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def delayed_auth(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @delayed_auth.setter
    def delayed_auth(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "delayed_auth", value)

    @property
    @pulumi.getter(name="disableNoCacheHeader")
    def disable_no_cache_header(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_no_cache_header(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def endpoint_overrides(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def endpoint_overrides(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def project_domain_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def project_domain_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "project_domain_id", value)

    @property
    @pulumi.getter(name="projectDomainName")
    def project_domain_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def project_domain_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def swauth(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @swauth.setter
    def swauth(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "swauth", value)

    @property
    @pulumi.getter(name="systemScope")
    def system_scope(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @system_scope.setter
    def system_scope(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def user_domain_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def user_domain_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "user_domain_id", value)

    @property
    @pulumi.getter(name="userDomainName")
    def user_domain_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def user_domain_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Provider(pulumi.ProviderResource):
    ...
    @property
    @pulumi.getter(name="applicationCredentialId")
    def application_credential_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Application Credential ID to login with.
        """
        return pulumi.get(self, "application_credential_id")
    ...
    @property
    @pulumi.getter(name="applicationCredentialName")
    def application_credential_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Application Credential name to login with.
        """
        return pulumi.get(self, "application_credential_name")
    ...
    @property
    @pulumi.getter(name="applicationCredentialSecret")
    def application_credential_secret(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Application Credential secret to login with.
        """
        return pulumi.get(self, "application_credential_secret")
    ...
    @property
    @pulumi.getter(name="defaultDomain")
    def default_domain(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Domain ID to scope to if no other domain is specified. Defaults to `default` (Identity v3).
        """
        return pulumi.get(self, "default_domain")
    ...
    @property
    @pulumi.getter(name="projectDomainId")
    def project_domain_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the domain where the proejct resides (Identity v3).
        """
        return pulumi.get(self, "project_domain_id")
    ...
    @property
    @pulumi.getter(name="projectDomainName")
    def project_domain_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the domain where the project resides (Identity v3).
        """
        return pulumi.get(self, "project_domain_name")
    ...
    @property
    @pulumi.getter(name="userDomainId")
    def user_domain_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the domain where the user resides (Identity v3).
        """
        return pulumi.get(self, "user_domain_id")
    ...
    @property
    @pulumi.getter(name="userDomainName")
    def user_domain_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the domain where the user resides (Identity v3).
        """
        return pulumi.get(self, "user_domain_name")
