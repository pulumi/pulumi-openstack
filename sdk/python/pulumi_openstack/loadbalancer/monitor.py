...
class MonitorArgs:
    def __init__(__self__, *,
                 ...
                 max_retries_down: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] delay: The time, in seconds, between sending probes to members.
        :param pulumi.Input[builtins.int] max_retries: Number of permissible ping failures before
               changing the member's status to INACTIVE. Must be a number between 1
               and 10.
        :param pulumi.Input[builtins.str] pool_id: The id of the pool that this monitor will be assigned to.
        :param pulumi.Input[builtins.int] timeout: Maximum number of seconds for a monitor to wait for a
               ping reply before it times out. The value must be less than the delay
               value.
        :param pulumi.Input[builtins.str] type: The type of probe, which is PING, TCP, HTTP, HTTPS,
        ...
        :param pulumi.Input[builtins.bool] admin_state_up: The administrative state of the monitor.
               A valid value is true (UP) or false (DOWN).
        :param pulumi.Input[builtins.str] domain_name: The domain name to use in the HTTP host header
               health monitor requests. Supported in Octavia API version 2.10 or later.
        :param pulumi.Input[builtins.str] expected_codes: Required for HTTP(S) types. Expected HTTP codes
               for a passing HTTP(S) monitor. You can either specify a single status like
               "200", a list like "200, 202" or a range like "200-202". Default is "200".
        :param pulumi.Input[builtins.str] http_method: Required for HTTP(S) types. The HTTP method that 
               the health monitor uses for requests. One of CONNECT, DELETE, GET, HEAD,
               OPTIONS, PATCH, POST, PUT, or TRACE. The default is GET.
        :param pulumi.Input[builtins.str] http_version: Required for HTTP(S) types. The HTTP version that
               ...
               2.10 or later.
        :param pulumi.Input[builtins.int] max_retries_down: Number of permissible ping failures before 
        ...
        :param pulumi.Input[builtins.str] url_path: Required for HTTP(S) types. URI path that will be
    ...
    def max_retries_down(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of permissible ping failures before 
        changing the member's status to ERROR. Must be a number between 1 and 10.
        The default is 3. Changing this updates the max_retries_down of the
    ...
    def max_retries_down(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Monitor(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            timeout: Optional[pulumi.Input[builtins.int]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            url_path: Optional[pulumi.Input[builtins.str]] = None) -> 'Monitor':
        """
    ...
    @property
    @pulumi.getter(name="expectedCodes")
    def expected_codes(self) -> pulumi.Output[builtins.str]:
        """
        Required for HTTP(S) types. Expected HTTP codes
        for a passing HTTP(S) monitor. You can either specify a single status like
        "200", a list like "200, 202" or a range like "200-202". Default is "200".
    ...
    @property
    @pulumi.getter(name="httpVersion")
    def http_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Required for HTTP(S) types. The HTTP version that
        the health monitor uses for requests. One of `1.0` or 1.1` is supported
        for HTTP(S) monitors. The default is `1.0`. Supported in Octavia API version
    ...
    @property
    @pulumi.getter(name="maxRetriesDown")
    def max_retries_down(self) -> pulumi.Output[builtins.int]:
        """
        Number of permissible ping failures before 
        changing the member's status to ERROR. Must be a number between 1 and 10.
        The default is 3. Changing this updates the max_retries_down of the
