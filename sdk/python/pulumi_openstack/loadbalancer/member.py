...
class MemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] backup: Boolean that indicates whether that member works as a backup or not. Available 
               only for Octavia >= 2.1.
        :param pulumi.Input[_builtins.str] monitor_address: An alternate IP address used for health monitoring a backend member.
               Available only for Octavia
        :param pulumi.Input[_builtins.int] monitor_port: An alternate protocol port used for health monitoring a backend member.
               Available only for Octavia
        ...
        :param pulumi.Input[_builtins.str] subnet_id: The subnet in which to access the member. Changing
               this creates a new member.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: A list of simple strings assigned to the member.
...
class Member(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="monitorAddress")
    def monitor_address(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        An alternate IP address used for health monitoring a backend member.
        Available only for Octavia
        """
    ...
    @_builtins.property
    @pulumi.getter(name="monitorPort")
    def monitor_port(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        An alternate protocol port used for health monitoring a backend member.
        Available only for Octavia
        """
