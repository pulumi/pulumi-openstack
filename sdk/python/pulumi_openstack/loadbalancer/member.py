...
class MemberArgs:
    def __init__(__self__, *,
                 ...
                 monitor_address: Optional[pulumi.Input[builtins.str]] = None,
                 monitor_port: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] address: The IP address of the member to receive traffic from
               the load balancer. Changing this creates a new member.
        :param pulumi.Input[builtins.str] pool_id: The id of the pool that this member will be assigned
        ...
        :param pulumi.Input[builtins.bool] admin_state_up: The administrative state of the member.
               A valid value is true (UP) or false (DOWN). Defaults to true.
        :param pulumi.Input[builtins.bool] backup: Boolean that indicates whether that member works as a backup or not. Available 
               only for Octavia >= 2.1.
        :param pulumi.Input[builtins.str] monitor_address: An alternate IP address used for health monitoring a backend member.
               Available only for Octavia
        :param pulumi.Input[builtins.int] monitor_port: An alternate protocol port used for health monitoring a backend member.
               Available only for Octavia
        :param pulumi.Input[builtins.str] name: Human-readable name for the member.
        ...
        :param pulumi.Input[builtins.str] subnet_id: The subnet in which to access the member. Changing
               this creates a new member.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of simple strings assigned to the member.
        ...
        :param pulumi.Input[builtins.int] weight: A positive integer value that indicates the relative
    ...
    def monitor_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def monitor_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "monitor_address", value)

    @property
    @pulumi.getter(name="monitorPort")
    def monitor_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @monitor_port.setter
    def monitor_port(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Member(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            weight: Optional[pulumi.Input[builtins.int]] = None) -> 'Member':
        """
    ...
    @property
    @pulumi.getter(name="monitorAddress")
    def monitor_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An alternate IP address used for health monitoring a backend member.
        Available only for Octavia
        """
    ...
    @property
    @pulumi.getter(name="monitorPort")
    def monitor_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        An alternate protocol port used for health monitoring a backend member.
        Available only for Octavia
        """
