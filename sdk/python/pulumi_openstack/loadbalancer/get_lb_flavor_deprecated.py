...
class GetLbFlavorDeprecatedResult:
    ...
    def flavor_profile_id(self) -> builtins.str:
        """
...
def get_lb_flavor_deprecated(flavor_id: Optional[builtins.str] = None,
    ...
    :param builtins.str flavor_id: The ID of the flavor. Exactly one of `name`, `flavor_id` is required to be set.
    :param builtins.str name: The name of the flavor. Exactly one of `name`, `flavor_id` is required to be set.
...
def get_lb_flavor_deprecated_output(flavor_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
