...
class QuotaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] l7_rule: Quota value for l7_rules. Changing this
               updates the existing quota. Omitting it sets it to 0. Available in
               **Octavia minor version 2.19**.
        :param pulumi.Input[_builtins.int] listener: Quota value for listeners. Changing this updates
               the existing quota. Omitting it sets it to 0.
        :param pulumi.Input[_builtins.int] loadbalancer: Quota value for loadbalancers. Changing this
               updates the existing quota. Omitting it sets it to 0.
        :param pulumi.Input[_builtins.int] member: Quota value for members. Changing this updates
               the existing quota. Omitting it sets it to 0.
        :param pulumi.Input[_builtins.int] pool: Quota value for pools. Changing this updates the
               the existing quota. Omitting it sets it to 0.
        :param pulumi.Input[_builtins.str] region: Region in which to manage quotas. Changing this
...
class Quota(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="healthMonitor")
    def health_monitor(self) -> pulumi.Output[_builtins.int]:
        """
        Quota value for health_monitors. Changing
        this updates the existing quota. Omitting it sets it to 0.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="l7Policy")
    def l7_policy(self) -> pulumi.Output[_builtins.int]:
        """
        Quota value for l7_policies. Changing this
        updates the existing quota. Omitting it sets it to 0. Available in
        **Octavia minor version 2.19**.
    ...
    @_builtins.property
    @pulumi.getter(name="l7Rule")
    def l7_rule(self) -> pulumi.Output[_builtins.int]:
        """
        Quota value for l7_rules. Changing this
        updates the existing quota. Omitting it sets it to 0. Available in
        **Octavia minor version 2.19**.
    ...
    @_builtins.property
    @pulumi.getter
    def listener(self) -> pulumi.Output[_builtins.int]:
        """
        Quota value for listeners. Changing this updates
        the existing quota. Omitting it sets it to 0.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def loadbalancer(self) -> pulumi.Output[_builtins.int]:
        """
        Quota value for loadbalancers. Changing this
        updates the existing quota. Omitting it sets it to 0.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def member(self) -> pulumi.Output[_builtins.int]:
        """
        Quota value for members. Changing this updates
        the existing quota. Omitting it sets it to 0.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def pool(self) -> pulumi.Output[_builtins.int]:
        """
        Quota value for pools. Changing this updates the
        the existing quota. Omitting it sets it to 0.
        """
