...
class L7PolicyV2Args:
    def __init__(__self__, *,
                 ...
                 redirect_http_code: Optional[pulumi.Input[builtins.int]] = None,
                 redirect_pool_id: Optional[pulumi.Input[builtins.str]] = None,
                 redirect_prefix: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] action: The L7 Policy action - can either be REDIRECT\\_TO\\_POOL,
               REDIRECT\\_TO\\_URL or REJECT.
        :param pulumi.Input[builtins.str] listener_id: The Listener on which the L7 Policy will be associated with.
               Changing this creates a new L7 Policy.
        :param pulumi.Input[builtins.bool] admin_state_up: The administrative state of the L7 Policy.
               A valid value is true (UP) or false (DOWN).
        :param pulumi.Input[builtins.str] description: Human-readable description for the L7 Policy.
        :param pulumi.Input[builtins.str] name: Human-readable name for the L7 Policy. Does not have
               to be unique.
        :param pulumi.Input[builtins.int] position: The position of this policy on the listener. Positions start at 1.
        :param pulumi.Input[builtins.int] redirect_http_code: Integer. Requests matching this policy will be  
        ...
        :param pulumi.Input[builtins.str] redirect_pool_id: Requests matching this policy will be redirected to the
               pool with this ID. Only valid if action is REDIRECT\\_TO\\_POOL.
        :param pulumi.Input[builtins.str] redirect_prefix: Requests matching this policy will be redirected to 
               this Prefix URL. Only valid if action is REDIRECT\\_PREFIX.
        :param pulumi.Input[builtins.str] redirect_url: Requests matching this policy will be redirected to this URL.
    ...
    def redirect_http_code(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def redirect_http_code(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def redirect_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def redirect_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class L7PolicyV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            redirect_url: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'L7PolicyV2':
        """
    ...
    @property
    @pulumi.getter(name="redirectHttpCode")
    def redirect_http_code(self) -> pulumi.Output[builtins.int]:
        """
        Integer. Requests matching this policy will be  
        redirected to the specified URL or Prefix URL with the HTTP response code.
        Valid if action is REDIRECT\\_TO\\_URL or REDIRECT\\_PREFIX. Valid options are:
    ...
    @property
    @pulumi.getter(name="redirectPrefix")
    def redirect_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Requests matching this policy will be redirected to 
        this Prefix URL. Only valid if action is REDIRECT\\_PREFIX.
        """
