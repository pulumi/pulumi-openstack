...
class L7RuleV2Args:
    def __init__(__self__, *,
                 compare_type: pulumi.Input[builtins.str],
                 l7policy_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] compare_type: The comparison type for the L7 rule - can either be
               CONTAINS, STARTS\\_WITH, ENDS_WITH, EQUAL_TO or REGEX
        :param pulumi.Input[builtins.str] l7policy_id: The ID of the L7 Policy to query. Changing this creates a new
               L7 Rule.
        :param pulumi.Input[builtins.str] type: The L7 Rule type - can either be COOKIE, FILE\\_TYPE, HEADER,
               HOST\\_NAME, PATH, SSL\\_CONN\\_HAS\\_CERT, SSL\\_VERIFY\\_RESULT or SSL\\_DN\\_FIELD.
        :param pulumi.Input[builtins.str] value: The value to use for the comparison. For example, the file type to
               compare.
        :param pulumi.Input[builtins.bool] admin_state_up: The administrative state of the L7 Rule.
               A valid value is true (UP) or false (DOWN).
        :param pulumi.Input[builtins.bool] invert: When true the logic of the rule is inverted. For example, with invert
               true, equal to would become not equal to. Default is false.
        :param pulumi.Input[builtins.str] key: The key to use for the comparison. For example, the name of the cookie to
    ...
    def compare_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @compare_type.setter
    def compare_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "compare_type", value)

    @property
    @pulumi.getter(name="l7policyId")
    def l7policy_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @l7policy_id.setter
    def l7policy_id(self, value: pulumi.Input[builtins.str]):
...
class _L7RuleV2State:
    def __init__(__self__, *,
                 admin_state_up: Optional[pulumi.Input[builtins.bool]] = None,
                 compare_type: Optional[pulumi.Input[builtins.str]] = None,
                 invert: Optional[pulumi.Input[builtins.bool]] = None,
                 key: Optional[pulumi.Input[builtins.str]] = None,
                 l7policy_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] l7policy_id: The ID of the L7 Policy to query. Changing this creates a new
               L7 Rule.
        :param pulumi.Input[builtins.str] listener_id: The ID of the Listener owning this resource.
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V2 Networking client.
               A Networking client is needed to create an L7 rule. If omitted, the
               `region` argument of the provider is used. Changing this creates a new
               L7 Rule.
    ...
    @property
    @pulumi.getter(name="compareType")
    def compare_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The comparison type for the L7 rule - can either be
        CONTAINS, STARTS\\_WITH, ENDS_WITH, EQUAL_TO or REGEX
        """
    ...
    @compare_type.setter
    def compare_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "compare_type", value)
    ...
    @property
    @pulumi.getter(name="l7policyId")
    def l7policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the L7 Policy to query. Changing this creates a new
        L7 Rule.
        """
    ...
    @l7policy_id.setter
    def l7policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "l7policy_id", value)
...
class L7RuleV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'L7RuleV2':
        """
    ...
    @property
    @pulumi.getter(name="compareType")
    def compare_type(self) -> pulumi.Output[builtins.str]:
        """
        The comparison type for the L7 rule - can either be
        CONTAINS, STARTS\\_WITH, ENDS_WITH, EQUAL_TO or REGEX
        """
    ...
    @property
    @pulumi.getter
    def invert(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When true the logic of the rule is inverted. For example, with invert
        true, equal to would become not equal to. Default is false.
        """
    ...
    @property
    @pulumi.getter(name="l7policyId")
    def l7policy_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the L7 Policy to query. Changing this creates a new
        L7 Rule.
        """
