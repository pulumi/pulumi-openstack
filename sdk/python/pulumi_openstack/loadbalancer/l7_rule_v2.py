...
class L7RuleV2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] l7policy_id: The ID of the L7 Policy to query. Changing this creates a new
               L7 Rule.
        :param pulumi.Input[_builtins.str] type: The L7 Rule type - can either be COOKIE, FILE\\_TYPE, HEADER,
               HOST\\_NAME, PATH, SSL\\_CONN\\_HAS\\_CERT, SSL\\_VERIFY\\_RESULT or SSL\\_DN\\_FIELD.
        :param pulumi.Input[_builtins.str] value: The value to use for the comparison. For example, the file type to
               compare.
        :param pulumi.Input[_builtins.bool] admin_state_up: The administrative state of the L7 Rule.
               A valid value is true (UP) or false (DOWN).
        :param pulumi.Input[_builtins.bool] invert: When true the logic of the rule is inverted. For example, with invert
...
class L7RuleV2(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def invert(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        When true the logic of the rule is inverted. For example, with invert
        true, equal to would become not equal to. Default is false.
        """
