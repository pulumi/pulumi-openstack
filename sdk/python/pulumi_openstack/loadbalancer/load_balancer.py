...
class LoadBalancerArgs:
    def __init__(__self__, *,
                 ...
                 loadbalancer_provider: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 vip_port_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] admin_state_up: The administrative state of the Loadbalancer.
               A valid value is true (UP) or false (DOWN).
        :param pulumi.Input[builtins.str] availability_zone: The availability zone of the Loadbalancer.
               Changing this creates a new loadbalancer. Available only for Octavia
               **minor version 2.14 or later**.
        :param pulumi.Input[builtins.str] description: Human-readable description for the Loadbalancer.
        :param pulumi.Input[builtins.str] flavor_id: The UUID of a flavor. Changing this creates a new
               loadbalancer.
        :param pulumi.Input[builtins.str] loadbalancer_provider: The name of the provider. Changing this
               creates a new loadbalancer.
        :param pulumi.Input[builtins.str] name: Human-readable name for the Loadbalancer. Does not have
               to be unique.
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V2 Networking client.
               A Networking client is needed to create an LB member. If omitted, the
               `region` argument of the provider is used. Changing this creates a new
               LB member.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: A list of security group IDs to apply to the
               loadbalancer. The security groups must be specified by ID and not name (as
               opposed to how they are configured with the Compute Instance).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of simple strings assigned to the loadbalancer.
        ...
        :param pulumi.Input[builtins.str] vip_address: The ip address of the load balancer.
               Changing this creates a new loadbalancer.
        :param pulumi.Input[builtins.str] vip_network_id: The network on which to allocate the
        ...
        :param pulumi.Input[builtins.str] vip_port_id: The port UUID that the loadbalancer will use.
               Changing this creates a new loadbalancer. Exactly one of
               `vip_subnet_id`, `vip_network_id` or `vip_port_id` has to be defined.
        :param pulumi.Input[builtins.str] vip_qos_policy_id: The ID of the QoS Policy which will 
               be applied to the Virtual IP (VIP).
        :param pulumi.Input[builtins.str] vip_subnet_id: The subnet on which to allocate the
               Loadbalancer's address. A tenant can only create Loadbalancers on networks
               authorized by policy (e.g. networks that belong to them or networks that
               are shared).  Changing this creates a new loadbalancer. Exactly one of
               `vip_subnet_id`, `vip_network_id` or `vip_port_id` has to be defined.
    ...
    def loadbalancer_provider(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def loadbalancer_provider(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vip_port_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @vip_port_id.setter
    def vip_port_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vip_port_id", value)

    @property
    @pulumi.getter(name="vipQosPolicyId")
    def vip_qos_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vip_qos_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LoadBalancer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="openstack:index/lbLoadbalancerV2:LbLoadbalancerV2")])
    ...
    @property
    @pulumi.getter(name="loadbalancerProvider")
    def loadbalancer_provider(self) -> pulumi.Output[builtins.str]:
        """
        The name of the provider. Changing this
        creates a new loadbalancer.
        """
    ...
    @property
    @pulumi.getter(name="vipPortId")
    def vip_port_id(self) -> pulumi.Output[builtins.str]:
        """
        The port UUID that the loadbalancer will use.
        Changing this creates a new loadbalancer. Exactly one of
        `vip_subnet_id`, `vip_network_id` or `vip_port_id` has to be defined.
    ...
    @property
    @pulumi.getter(name="vipQosPolicyId")
    def vip_qos_policy_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the QoS Policy which will 
        be applied to the Virtual IP (VIP).
        """
