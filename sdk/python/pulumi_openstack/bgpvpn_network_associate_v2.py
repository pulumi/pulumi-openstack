...
class BgpvpnNetworkAssociateV2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bgpvpn_id: The ID of the BGP VPN to which the network will be
               associated. Changing this creates a new BGP VPN network association
        :param pulumi.Input[builtins.str] network_id: The ID of the network to be associated with the BGP
               VPN. Changing this creates a new BGP VPN network association.
        :param pulumi.Input[builtins.str] project_id: The ID of the project that owns the BGP VPN network
...
@pulumi.type_token("openstack:index/bgpvpnNetworkAssociateV2:BgpvpnNetworkAssociateV2")
class BgpvpnNetworkAssociateV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_id: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'BgpvpnNetworkAssociateV2':
        """
