...
class GetQuotaV2Result:
    ...
    @_builtins.property
    @pulumi.getter
    def floatingip(self) -> _builtins.int:
        """
    ...
    def rbac_policy(self) -> _builtins.int:
        """
    ...
    def security_group(self) -> _builtins.int:
        """
    ...
    def security_group_rule(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def subnetpool(self) -> _builtins.int:
...
def get_quota_v2(project_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str project_id: The id of the project to retrieve the quota.
    :param _builtins.str region: The region in which to obtain the V2 Network client.
