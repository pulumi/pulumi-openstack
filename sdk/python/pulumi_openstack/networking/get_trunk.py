...
class GetTrunkResult:
    ...
    def trunk_id(self) -> Optional[builtins.str]:
...
def get_trunk(admin_state_up: Optional[builtins.bool] = None,
              ...
              trunk_id: Optional[builtins.str] = None,
    ...
    :param builtins.bool admin_state_up: The administrative state of the trunk.
    :param builtins.str description: Human-readable description of the trunk.
    :param builtins.str name: The name of the trunk.
    :param builtins.str port_id: The ID of the trunk parent port.
    :param builtins.str project_id: The owner of the trunk.
    ...
    :param builtins.str status: The status of the trunk.
    :param Sequence[builtins.str] tags: The list of trunk tags to filter.
    :param builtins.str trunk_id: The ID of the trunk.
    """
    __args__ = dict()
...
def get_trunk_output(admin_state_up: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                     ...
                     trunk_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
