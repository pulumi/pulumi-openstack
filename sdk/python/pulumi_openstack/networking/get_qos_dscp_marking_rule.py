...
class GetQosDscpMarkingRuleResult:
    ...
    def dscp_mark(self) -> _builtins.int:
        """
...
def get_qos_dscp_marking_rule(dscp_mark: Optional[_builtins.int] = None,
    ...
    :param _builtins.int dscp_mark: The value of a DSCP mark.
...
def get_qos_dscp_marking_rule_output(dscp_mark: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
