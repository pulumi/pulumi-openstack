...
class GetSubnetIdsV2Result:
    ...
    def dhcp_enabled(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "dhcp_enabled")

    @property
    @pulumi.getter(name="dnsPublishFixedIp")
    def dns_publish_fixed_ip(self) -> Optional[builtins.bool]:
    ...
    def ipv6_address_mode(self) -> Optional[builtins.str]:
    ...
    def subnetpool_id(self) -> Optional[builtins.str]:
...
def get_subnet_ids_v2(cidr: Optional[builtins.str] = None,
                      description: Optional[builtins.str] = None,
                      dhcp_enabled: Optional[builtins.bool] = None,
                      dns_publish_fixed_ip: Optional[builtins.bool] = None,
                      gateway_ip: Optional[builtins.str] = None,
                      ip_version: Optional[builtins.int] = None,
                      ipv6_address_mode: Optional[builtins.str] = None,
                      ipv6_ra_mode: Optional[builtins.str] = None,
    ...
    :param builtins.str cidr: The CIDR of the subnet.
    :param builtins.str description: Human-readable description of the subnet.
    :param builtins.bool dhcp_enabled: If the subnet has DHCP enabled.
    :param builtins.bool dns_publish_fixed_ip: If the subnet publishes DNS records.
    :param builtins.str gateway_ip: The IP of the subnet's gateway.
    :param builtins.int ip_version: The IP version of the subnet (either 4 or 6).
    :param builtins.str ipv6_address_mode: The IPv6 address mode. Valid values are
           `dhcpv6-stateful`, `dhcpv6-stateless`, or `slaac`.
    :param builtins.str ipv6_ra_mode: The IPv6 Router Advertisement mode. Valid values
           are `dhcpv6-stateful`, `dhcpv6-stateless`, or `slaac`.
    :param builtins.str name: The name of the subnet.
    :param builtins.str network_id: The ID of the network the subnet belongs to.
    ...
    :param builtins.str tenant_id: The owner of the subnet.
    """
    __args__ = dict()
    __args__['cidr'] = cidr
...
def get_subnet_ids_v2_output(cidr: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             dhcp_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                             dns_publish_fixed_ip: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                             gateway_ip: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             ip_version: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                             ipv6_address_mode: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             ipv6_ra_mode: Optional[pulumi.Input[Optional[builtins.str]]] = None,
