...
class GetPortResult:
    ...
    def dns_assignments(self) -> Sequence[Mapping[str, _builtins.str]]:
        """
...
def get_port(admin_state_up: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str dns_name: The port DNS name to filter. Available, when Neutron
...
def get_port_output(admin_state_up: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
