...
class GetPortResult:
    ...
    def all_fixed_ips(self) -> Sequence[builtins.str]:
        """
    ...
    def all_security_group_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def device_owner(self) -> Optional[builtins.str]:
        """
        See Argument Reference above.
        """
    ...
    def dns_assignments(self) -> Sequence[Mapping[str, builtins.str]]:
        """
...
def get_port(admin_state_up: Optional[builtins.bool] = None,
             description: Optional[builtins.str] = None,
             device_id: Optional[builtins.str] = None,
             device_owner: Optional[builtins.str] = None,
    ...
    :param builtins.bool admin_state_up: The administrative state of the port.
    :param builtins.str description: Human-readable description of the port.
    :param builtins.str device_id: The ID of the device the port belongs to.
    :param builtins.str device_owner: The device owner of the port.
    :param builtins.str dns_name: The port DNS name to filter. Available, when Neutron
           DNS extension is enabled.
    :param builtins.str fixed_ip: The port IP address filter.
    :param builtins.str mac_address: The MAC address of the port.
    :param builtins.str name: The name of the port.
    :param builtins.str network_id: The ID of the network the port belongs to.
    :param builtins.str port_id: The ID of the port.
    :param builtins.str project_id: The owner of the port.
    :param builtins.str region: The region in which to obtain the V2 Neutron client.
           A Neutron client is needed to retrieve port ids. If omitted, the
           `region` argument of the provider is used.
    :param Sequence[builtins.str] security_group_ids: The list of port security group IDs to filter.
    :param builtins.str status: The status of the port.
    :param Sequence[builtins.str] tags: The list of port tags to filter.
    """
    __args__ = dict()
...
def get_port_output(admin_state_up: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                    description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                    device_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                    device_owner: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                    dns_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                    fixed_ip: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                    ...
                    port_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
