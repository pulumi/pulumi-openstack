...
class GetQosMinimumBandwidthRuleResult:
    ...
    def min_kbps(self) -> _builtins.int:
        """
    ...
    def qos_policy_id(self) -> _builtins.str:
        """
        See Argument Reference above.
        """
...
def get_qos_minimum_bandwidth_rule(direction: Optional[_builtins.str] = None,
                                   min_kbps: Optional[_builtins.int] = None,
                                   qos_policy_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.int min_kbps: The value of a minimum kbps bandwidth.
    :param _builtins.str qos_policy_id: The QoS policy reference.
...
def get_qos_minimum_bandwidth_rule_output(direction: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('openstack:networking/getQosMinimumBandwidthRule:getQosMinimumBandwidthRule', __args__, opts=opts, typ=GetQosMinimumBandwidthRuleResult)
    return __ret__.apply(lambda __response__: GetQosMinimumBandwidthRuleResult(
        direction=pulumi.get(__response__, 'direction'),
        id=pulumi.get(__response__, 'id'),
        min_kbps=pulumi.get(__response__, 'min_kbps'),
