...
class QosPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_default: Indicates whether the QoS policy is default
               ...
               QoS policy.
        :param pulumi.Input[_builtins.str] name: The name of the QoS policy. Changing this updates the name of
               the existing QoS policy.
        :param pulumi.Input[_builtins.str] project_id: The owner of the QoS policy. Required if admin wants to
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to obtain the V2 Networking client.
               ...
               QoS policy.
        :param pulumi.Input[_builtins.bool] shared: Indicates whether this QoS policy is shared across
               all projects. Changing this updates the shared status of the existing
               QoS policy.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: A set of string tags for the QoS policy.
...
class _QosPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to obtain the V2 Networking client.
               ...
               `region` argument of the provider is used. Changing this creates a new
               QoS policy.
        :param pulumi.Input[_builtins.int] revision_number: The revision number of the QoS policy.
        :param pulumi.Input[_builtins.bool] shared: Indicates whether this QoS policy is shared across
               all projects. Changing this updates the shared status of the existing
               QoS policy.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: A set of string tags for the QoS policy.
        :param pulumi.Input[_builtins.str] updated_at: The time at which QoS policy was created.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] value_specs: Map of additional options.
        """
...
class QosPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            value_specs: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'QosPolicy':
        """
