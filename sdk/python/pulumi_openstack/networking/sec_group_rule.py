...
class SecGroupRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] security_group_id: The security group id the rule should belong
        ...
        :param pulumi.Input[_builtins.int] port_range_max: The higher part of the allowed port range, valid
               integer value needs to be between 1 and 65535. Changing this creates a new
               security group rule.
        :param pulumi.Input[_builtins.int] port_range_min: The lower part of the allowed port range, valid
               integer value needs to be between 1 and 65535. Changing this creates a new
               security group rule.
        :param pulumi.Input[_builtins.str] protocol: The layer 4 protocol type, valid values are
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to obtain the V2 networking client.
               ...
               security group rule.
        :param pulumi.Input[_builtins.str] remote_address_group_id: The remote address group id, the value
        ...
        :param pulumi.Input[_builtins.str] remote_group_id: The remote group id, the value needs to be an
               Openstack ID of a security group in the same tenant. Changing this creates
               a new security group rule.
        :param pulumi.Input[_builtins.str] remote_ip_prefix: The remote CIDR, the value needs to be a valid
               CIDR (i.e. 192.168.0.0/16). Changing this creates a new security group rule.
        :param pulumi.Input[_builtins.str] tenant_id: The owner of the security group. Required if admin
