...
class SubnetRouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] destination_cidr: CIDR block to match on the packet’s destination IP. Changing
               this creates a new routing entry.
        :param pulumi.Input[builtins.str] next_hop: IP address of the next hop gateway.  Changing
               this creates a new routing entry.
        :param pulumi.Input[builtins.str] subnet_id: ID of the subnet this routing entry belongs to. Changing
               this creates a new routing entry.
...
@pulumi.type_token("openstack:networking/subnetRoute:SubnetRoute")
class SubnetRoute(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            next_hop: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            subnet_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SubnetRoute':
        """
    ...
    @property
    @pulumi.getter(name="destinationCidr")
    def destination_cidr(self) -> pulumi.Output[builtins.str]:
        """
        CIDR block to match on the packet’s destination IP. Changing
        this creates a new routing entry.
        """
    ...
    @property
    @pulumi.getter(name="nextHop")
    def next_hop(self) -> pulumi.Output[builtins.str]:
        """
        IP address of the next hop gateway.  Changing
        this creates a new routing entry.
        """
