...
class SubnetRouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] next_hop: IP address of the next hop gateway.  Changing
               this creates a new routing entry.
        :param pulumi.Input[_builtins.str] subnet_id: ID of the subnet this routing entry belongs to. Changing
               this creates a new routing entry.
...
class SubnetRoute(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            next_hop: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            subnet_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'SubnetRoute':
        """
