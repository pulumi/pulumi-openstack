...
class GetNetworkResult:
    ...
    def availability_zone_hints(self) -> Sequence[builtins.str]:
        """
    ...
    def matching_subnet_cidr(self) -> Optional[builtins.str]:
    ...
    def transparent_vlan(self) -> Optional[builtins.bool]:
        """
        See Argument Reference above.
        """
...
def get_network(description: Optional[builtins.str] = None,
                external: Optional[builtins.bool] = None,
                matching_subnet_cidr: Optional[builtins.str] = None,
                ...
                transparent_vlan: Optional[builtins.bool] = None,
    ...
    :param builtins.str description: Human-readable description of the network.
    :param builtins.bool external: The external routing facility of the network.
    :param builtins.str matching_subnet_cidr: The CIDR of a subnet within the network.
    :param builtins.int mtu: The network MTU to filter. Available, when Neutron `net-mtu`
    ...
    :param builtins.str status: The status of the network.
    :param Sequence[builtins.str] tags: The list of network tags to filter.
    :param builtins.str tenant_id: The owner of the network.
    :param builtins.bool transparent_vlan: The VLAN transparent attribute for the
           network.
    """
    __args__ = dict()
...
def get_network_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       external: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                       matching_subnet_cidr: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       mtu: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                       ...
                       transparent_vlan: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
