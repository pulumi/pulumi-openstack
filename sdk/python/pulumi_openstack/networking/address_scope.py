...
class AddressScopeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] ip_version: IP version, either 4 (default) or 6. Changing this
               creates a new address-scope.
        :param pulumi.Input[builtins.str] name: The name of the address-scope. Changing this updates the
               name of the existing address-scope.
        :param pulumi.Input[builtins.str] project_id: The owner of the address-scope. Required if admin
        ...
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V2 Networking client.
               ...
               address-scope.
        :param pulumi.Input[builtins.bool] shared: Indicates whether this address-scope is shared across
...
@pulumi.type_token("openstack:networking/addressScope:AddressScope")
class AddressScope(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            shared: Optional[pulumi.Input[builtins.bool]] = None) -> 'AddressScope':
        """
