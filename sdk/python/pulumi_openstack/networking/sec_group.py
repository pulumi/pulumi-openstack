...
class SecGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] delete_default_rules: Whether or not to delete the default
               egress security rules. This is `false` by default. See the below note
               for more information.
        :param pulumi.Input[builtins.str] description: A unique name for the security group.
        :param pulumi.Input[builtins.str] name: A unique name for the security group.
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V2 networking client.
               A networking client is needed to create a port. If omitted, the
               `region` argument of the provider is used. Changing this creates a new
               security group.
        :param pulumi.Input[builtins.bool] stateful: Indicates if the security group is stateful or
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A set of string tags for the security group.
...
class _SecGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] all_tags: The collection of tags assigned on the security group, which have
...
@pulumi.type_token("openstack:networking/secGroup:SecGroup")
class SecGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            stateful: Optional[pulumi.Input[builtins.bool]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SecGroup':
        """
    ...
    @property
    @pulumi.getter
    def stateful(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates if the security group is stateful or
        stateless. Update of the stateful argument is allowed when there is no port
        associated with the security group. Available only in OpenStack environments
