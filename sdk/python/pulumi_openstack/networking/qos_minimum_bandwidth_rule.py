...
class QosMinimumBandwidthRuleArgs:
    def __init__(__self__, *,
                 min_kbps: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.int] min_kbps: The minimum kilobits per second. Changing this updates the min kbps value of the existing
               QoS minimum bandwidth rule.
        :param pulumi.Input[builtins.str] qos_policy_id: The QoS policy reference. Changing this creates a new QoS minimum bandwidth rule.
    ...
    def min_kbps(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @min_kbps.setter
    def min_kbps(self, value: pulumi.Input[builtins.int]):
...
class _QosMinimumBandwidthRuleState:
    def __init__(__self__, *,
                 direction: Optional[pulumi.Input[builtins.str]] = None,
                 min_kbps: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="minKbps")
    def min_kbps(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The minimum kilobits per second. Changing this updates the min kbps value of the existing
        QoS minimum bandwidth rule.
        """
    ...
    @min_kbps.setter
    def min_kbps(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "min_kbps", value)
...
class QosMinimumBandwidthRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            min_kbps: Optional[pulumi.Input[builtins.int]] = None,
            qos_policy_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'QosMinimumBandwidthRule':
        """
    ...
    @property
    @pulumi.getter(name="minKbps")
    def min_kbps(self) -> pulumi.Output[builtins.int]:
        """
        The minimum kilobits per second. Changing this updates the min kbps value of the existing
        QoS minimum bandwidth rule.
        """
