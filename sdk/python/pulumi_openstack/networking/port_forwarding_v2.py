...
class PortForwardingV2Args:
    def __init__(__self__, *,
                 ...
                 floatingip_id: pulumi.Input[builtins.str],
                 internal_ip_address: pulumi.Input[builtins.str],
                 internal_port: pulumi.Input[builtins.int],
                 internal_port_id: pulumi.Input[builtins.str],
                 protocol: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a PortForwardingV2 resource.
        :param pulumi.Input[builtins.int] external_port: The TCP/UDP/other protocol port number of the port forwarding. Changing this
               updates the `external_port` of an existing port forwarding.
        :param pulumi.Input[builtins.str] floatingip_id: The ID of the Neutron floating IP address. Changing this creates a new port forwarding.
        :param pulumi.Input[builtins.str] internal_ip_address: The fixed IPv4 address of the Neutron port associated with the port forwarding.
               Changing this updates the `internal_ip_address` of an existing port forwarding.
        :param pulumi.Input[builtins.int] internal_port: The TCP/UDP/other protocol port number of the Neutron port fixed IP address associated to the
               port forwarding. Changing this updates the `internal_port` of an existing port forwarding.
        :param pulumi.Input[builtins.str] internal_port_id: The ID of the Neutron port associated with the port forwarding. Changing
               this updates the `internal_port_id` of an existing port forwarding.
        :param pulumi.Input[builtins.str] protocol: The IP protocol used in the port forwarding. Changing this updates the `protocol`
               of an existing port forwarding.
        :param pulumi.Input[builtins.str] description: A text describing the port forwarding. Changing this
    ...
    def floatingip_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def floatingip_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "floatingip_id", value)

    @property
    @pulumi.getter(name="internalIpAddress")
    def internal_ip_address(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def internal_ip_address(self, value: pulumi.Input[builtins.str]):
    ...
    def internal_port_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def internal_port_id(self, value: pulumi.Input[builtins.str]):
...
class _PortForwardingV2State:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 external_port: Optional[pulumi.Input[builtins.int]] = None,
                 floatingip_id: Optional[pulumi.Input[builtins.str]] = None,
                 internal_ip_address: Optional[pulumi.Input[builtins.str]] = None,
                 internal_port: Optional[pulumi.Input[builtins.int]] = None,
                 internal_port_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="externalPort")
    def external_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The TCP/UDP/other protocol port number of the port forwarding. Changing this
        updates the `external_port` of an existing port forwarding.
        """
    ...
    @external_port.setter
    def external_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "external_port", value)

    @property
    @pulumi.getter(name="floatingipId")
    def floatingip_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Neutron floating IP address. Changing this creates a new port forwarding.
        """
        return pulumi.get(self, "floatingip_id")
    ...
    @floatingip_id.setter
    def floatingip_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "floatingip_id", value)

    @property
    @pulumi.getter(name="internalIpAddress")
    def internal_ip_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The fixed IPv4 address of the Neutron port associated with the port forwarding.
        Changing this updates the `internal_ip_address` of an existing port forwarding.
        """
    ...
    @internal_ip_address.setter
    def internal_ip_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "internal_ip_address", value)

    @property
    @pulumi.getter(name="internalPort")
    def internal_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The TCP/UDP/other protocol port number of the Neutron port fixed IP address associated to the
        port forwarding. Changing this updates the `internal_port` of an existing port forwarding.
        """
    ...
    @internal_port.setter
    def internal_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "internal_port", value)

    @property
    @pulumi.getter(name="internalPortId")
    def internal_port_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Neutron port associated with the port forwarding. Changing
        this updates the `internal_port_id` of an existing port forwarding.
        """
    ...
    @internal_port_id.setter
    def internal_port_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "internal_port_id", value)
...
@pulumi.type_token("openstack:networking/portForwardingV2:PortForwardingV2")
class PortForwardingV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            internal_port_id: Optional[pulumi.Input[builtins.str]] = None,
            protocol: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'PortForwardingV2':
        """
    ...
    @property
    @pulumi.getter(name="externalPort")
    def external_port(self) -> pulumi.Output[builtins.int]:
        """
        The TCP/UDP/other protocol port number of the port forwarding. Changing this
        updates the `external_port` of an existing port forwarding.
        """
    ...
    @property
    @pulumi.getter(name="floatingipId")
    def floatingip_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Neutron floating IP address. Changing this creates a new port forwarding.
        """
        return pulumi.get(self, "floatingip_id")
    ...
    @property
    @pulumi.getter(name="internalIpAddress")
    def internal_ip_address(self) -> pulumi.Output[builtins.str]:
        """
        The fixed IPv4 address of the Neutron port associated with the port forwarding.
        Changing this updates the `internal_ip_address` of an existing port forwarding.
        """
    ...
    @property
    @pulumi.getter(name="internalPort")
    def internal_port(self) -> pulumi.Output[builtins.int]:
        """
        The TCP/UDP/other protocol port number of the Neutron port fixed IP address associated to the
        port forwarding. Changing this updates the `internal_port` of an existing port forwarding.
        """
    ...
    @property
    @pulumi.getter(name="internalPortId")
    def internal_port_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Neutron port associated with the port forwarding. Changing
        this updates the `internal_port_id` of an existing port forwarding.
        """
