...
class SubnetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cidr: CIDR representing IP range for this subnet, based on IP
               version. You can omit this option if you are creating a subnet from a
               subnet pool.
        :param pulumi.Input[_builtins.str] description: Human-readable description of the subnet. Changing this
               updates the name of the existing subnet.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dns_nameservers: An array of DNS name server names used by hosts
               in this subnet. Changing this updates the DNS name servers for the existing
               subnet.
        :param pulumi.Input[_builtins.bool] dns_publish_fixed_ip: Whether to publish DNS records for IPs
               from this subnet. Defaults is false.
        :param pulumi.Input[_builtins.bool] enable_dhcp: The administrative state of the network.
               Acceptable values are "true" and "false". Changing this value enables or
               disables the DHCP capabilities of the existing subnet. Defaults to true.
        :param pulumi.Input[_builtins.str] gateway_ip: Default gateway used by devices in this subnet.
               Leaving this blank and not setting `no_gateway` will cause a default
               gateway of `.1` to be used. Changing this updates the gateway IP of the
               existing subnet.
        :param pulumi.Input[_builtins.int] ip_version: IP version, either 4 (default) or 6. Changing this creates a
               new subnet.
        :param pulumi.Input[_builtins.str] ipv6_address_mode: The IPv6 address mode. Valid values are
               `dhcpv6-stateful`, `dhcpv6-stateless`, or `slaac`.
        :param pulumi.Input[_builtins.str] ipv6_ra_mode: The IPv6 Router Advertisement mode. Valid values
               are `dhcpv6-stateful`, `dhcpv6-stateless`, or `slaac`.
        :param pulumi.Input[_builtins.str] name: The name of the subnet. Changing this updates the name of
               the existing subnet.
        :param pulumi.Input[_builtins.bool] no_gateway: Do not set a gateway IP on this subnet. Changing
               this removes or adds a default gateway IP of the existing subnet.
        :param pulumi.Input[_builtins.int] prefix_length: The prefix length to use when creating a subnet
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to obtain the V2 Networking client.
               ...
               subnet.
        :param pulumi.Input[_builtins.str] segment_id: The segment ID of the subnet. This is used to
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] service_types: An array of service types used by the subnet.
               Changing this updates the service types for the existing subnet.
        :param pulumi.Input[_builtins.str] subnetpool_id: The ID of the subnetpool associated with the subnet.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: A set of string tags for the subnet.
        :param pulumi.Input[_builtins.str] tenant_id: The owner of the subnet. Required if admin wants to
...
class Subnet(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="dnsPublishFixedIp")
    def dns_publish_fixed_ip(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Whether to publish DNS records for IPs
        from this subnet. Defaults is false.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="segmentId")
    def segment_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The segment ID of the subnet. This is used to
        specify which segment the subnet belongs to when using Neutron's routed
        provider networks. Available when neutron segment extension is enabled.
    ...
    @_builtins.property
    @pulumi.getter(name="subnetpoolId")
    def subnetpool_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of the subnetpool associated with the subnet.
        """
        return pulumi.get(self, "subnetpool_id")
