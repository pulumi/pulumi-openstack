...
class GetSubnetPoolResult:
    ...
    def all_tags(self) -> Sequence[builtins.str]:
        """
    ...
    def default_prefixlen(self) -> builtins.int:
        """
        See Argument Reference above.
        """
    ...
    def default_quota(self) -> builtins.int:
        """
        See Argument Reference above.
        """
    ...
    def max_prefixlen(self) -> builtins.int:
        """
        See Argument Reference above.
        """
    ...
    def min_prefixlen(self) -> builtins.int:
        """
        See Argument Reference above.
        """
...
def get_subnet_pool(address_scope_id: Optional[builtins.str] = None,
                    default_prefixlen: Optional[builtins.int] = None,
                    default_quota: Optional[builtins.int] = None,
                    description: Optional[builtins.str] = None,
                    ip_version: Optional[builtins.int] = None,
                    is_default: Optional[builtins.bool] = None,
                    max_prefixlen: Optional[builtins.int] = None,
                    min_prefixlen: Optional[builtins.int] = None,
    ...
    :param builtins.str address_scope_id: The Neutron address scope that subnetpools
           is assigned to.
    :param builtins.int default_prefixlen: The size of the subnetpool default prefix
           length.
    :param builtins.int default_quota: The per-project quota on the prefix space that
           can be allocated from the subnetpool for project subnets.
    :param builtins.str description: The human-readable description for the subnetpool.
    :param builtins.int ip_version: The IP protocol version.
    :param builtins.bool is_default: Whether the subnetpool is default subnetpool or not.
    :param builtins.int max_prefixlen: The size of the subnetpool max prefix length.
    :param builtins.int min_prefixlen: The size of the subnetpool min prefix length.
    :param builtins.str name: The name of the subnetpool.
    :param builtins.str project_id: The owner of the subnetpool.
    ...
    :param builtins.bool shared: Whether this subnetpool is shared across all projects.
    :param Sequence[builtins.str] tags: The list of subnetpool tags to filter.
    """
    __args__ = dict()
...
def get_subnet_pool_output(address_scope_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           default_prefixlen: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                           default_quota: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                           ...
                           max_prefixlen: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                           min_prefixlen: Optional[pulumi.Input[Optional[builtins.int]]] = None,
