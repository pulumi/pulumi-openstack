...
def get_qos_policy(description: Optional[_builtins.str] = None,
    ...
    :param _builtins.str description: The human-readable description for the QoS policy.
    :param _builtins.bool is_default: Whether the QoS policy is default policy or not.
    :param _builtins.str name: The name of the QoS policy.
    :param _builtins.str project_id: The owner of the QoS policy.
    ...
    :param _builtins.bool shared: Whether this QoS policy is shared across all projects.
    :param Sequence[_builtins.str] tags: The list of QoS policy tags to filter.
    """
    __args__ = dict()
