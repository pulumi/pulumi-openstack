...
class QosDscpMarkingRuleArgs:
    ...
    def dscp_mark(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    @dscp_mark.setter
    def dscp_mark(self, value: pulumi.Input[_builtins.int]):
...
@pulumi.type_token("openstack:networking/qosDscpMarkingRule:QosDscpMarkingRule")
class QosDscpMarkingRule(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="dscpMark")
    def dscp_mark(self) -> pulumi.Output[_builtins.int]:
        """
        The value of DSCP mark. Changing this updates the DSCP mark value existing
        QoS DSCP marking rule.
        """
