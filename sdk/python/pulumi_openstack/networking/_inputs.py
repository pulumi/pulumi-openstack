...
class PortBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] profile: Custom data to be passed as `binding:profile`. Data
               must be passed as JSON.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] vif_details: A map of JSON strings containing additional
               details for this specific binding.
        :param pulumi.Input[_builtins.str] vif_type: The VNIC type of the port binding.
        :param pulumi.Input[_builtins.str] vnic_type: VNIC type for the port. Can either be `direct`,
               `direct-physical`, `macvtap`, `normal`, `baremetal` or `virtio-forwarder`.
               Default value is `normal`. It can be updated on unbound ports only.
        """
...
class PortFixedIpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ip_address: IP address desired in the subnet for this port. If
               ...
               is left blank or omitted. To retrieve the assigned IP address, use the
               `all_fixed_ips` attribute.
        :param pulumi.Input[_builtins.str] subnet_id: Subnet in which to allocate IP address for
               this port.
        """
...
class RouterRoutesV2RouteArgs:
    def __init__(__self__, *,
                 ...
                 next_hop: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] destination_cidr: CIDR block to match on the packet’s
               destination IP.
        :param pulumi.Input[_builtins.str] next_hop: IP address of the next hop gateway.
        """
...
if not MYPY:
    class TrunkSubPortArgsDict(TypedDict):
        ...
        """
        segmentation_type: pulumi.Input[_builtins.str]
        """
...
class TrunkSubPortArgs:
    def __init__(__self__, *,
                 ...
                 segmentation_type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] port_id: The ID of the port to be made a subport of the trunk.
        :param pulumi.Input[_builtins.int] segmentation_id: The numeric id of the subport segment.
        :param pulumi.Input[_builtins.str] segmentation_type: The segmentation technology to use, e.g., "vlan".
        """
    ...
    def segmentation_type(self) -> pulumi.Input[_builtins.str]:
        """
        The segmentation technology to use, e.g., "vlan".
        """
    ...
    def segmentation_type(self, value: pulumi.Input[_builtins.str]):
