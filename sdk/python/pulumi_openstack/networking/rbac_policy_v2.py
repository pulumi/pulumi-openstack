...
class RbacPolicyV2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] object_type: The type of the object that the RBAC policy
               affects. Can be one of the following: `address_scope`, `address_group`,
               `network`, `qos_policy`, `security_group`, `subnetpool` or `bgpvpn`.
        :param pulumi.Input[_builtins.str] target_tenant: The ID of the tenant to which the RBAC policy
               will be enforced.
    ...
    def target_tenant(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def target_tenant(self, value: pulumi.Input[_builtins.str]):
...
class RbacPolicyV2(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="targetTenant")
    def target_tenant(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the tenant to which the RBAC policy
        will be enforced.
        """
