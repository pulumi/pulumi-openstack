...
class RbacPolicyV2Args:
    def __init__(__self__, *,
                 ...
                 target_tenant: pulumi.Input[builtins.str],
                 region: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RbacPolicyV2 resource.
        :param pulumi.Input[builtins.str] action: Action for the RBAC policy. Can either be
               `access_as_external` or `access_as_shared`.
        :param pulumi.Input[builtins.str] object_id: The ID of the `object_type` resource. An
               `object_type` of `network` returns a network ID and an `object_type` of
               `qos_policy` returns a QoS ID.
        :param pulumi.Input[builtins.str] object_type: The type of the object that the RBAC policy
               affects. Can be one of the following: `address_scope`, `address_group`,
               `network`, `qos_policy`, `security_group`, `subnetpool` or `bgpvpn`.
        :param pulumi.Input[builtins.str] target_tenant: The ID of the tenant to which the RBAC policy
               will be enforced.
    ...
    def target_tenant(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_tenant(self, value: pulumi.Input[builtins.str]):
...
class RbacPolicyV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            target_tenant: Optional[pulumi.Input[builtins.str]] = None) -> 'RbacPolicyV2':
        """
    ...
    @property
    @pulumi.getter(name="targetTenant")
    def target_tenant(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the tenant to which the RBAC policy
        will be enforced.
        """
