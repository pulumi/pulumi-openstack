...
class QuotaV2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] network: Quota value for networks. Changing this updates the
               existing quota.
        :param pulumi.Input[_builtins.int] port: Quota value for ports. Changing this updates the
               existing quota.
        :param pulumi.Input[_builtins.int] rbac_policy: Quota value for RBAC policies.
               Changing this updates the existing quota.
        :param pulumi.Input[_builtins.str] region: The region in which to create the quota. If
               omitted, the `region` argument of the provider is used. Changing this
               creates new quota.
        :param pulumi.Input[_builtins.int] router: Quota value for routers. Changing this updates the
               existing quota.
        :param pulumi.Input[_builtins.int] security_group: Quota value for security groups. Changing
               this updates the existing quota.
        :param pulumi.Input[_builtins.int] security_group_rule: Quota value for security group rules.
               Changing this updates the existing quota.
        :param pulumi.Input[_builtins.int] subnet: Quota value for subnets. Changing
               this updates the existing quota.
        :param pulumi.Input[_builtins.int] subnetpool: Quota value for subnetpools.
               Changing this updates the existing quota.
        """
...
class QuotaV2(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def floatingip(self) -> pulumi.Output[_builtins.int]:
        """
        Quota value for floating IPs. Changing this updates the
        existing quota.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def network(self) -> pulumi.Output[_builtins.int]:
        """
        Quota value for networks. Changing this updates the
        existing quota.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="rbacPolicy")
    def rbac_policy(self) -> pulumi.Output[_builtins.int]:
        """
        Quota value for RBAC policies.
        Changing this updates the existing quota.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def router(self) -> pulumi.Output[_builtins.int]:
        """
        Quota value for routers. Changing this updates the
        existing quota.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="securityGroup")
    def security_group(self) -> pulumi.Output[_builtins.int]:
        """
        Quota value for security groups. Changing
        this updates the existing quota.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="securityGroupRule")
    def security_group_rule(self) -> pulumi.Output[_builtins.int]:
        """
        Quota value for security group rules.
        Changing this updates the existing quota.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def subnet(self) -> pulumi.Output[_builtins.int]:
        """
        Quota value for subnets. Changing
        this updates the existing quota.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def subnetpool(self) -> pulumi.Output[_builtins.int]:
        """
        Quota value for subnetpools.
        Changing this updates the existing quota.
        """
