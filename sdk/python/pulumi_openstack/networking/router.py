...
class RouterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] availability_zone_hints: An availability zone is used to make
               network resources highly available. Used for resources with high availability
               so that they are scheduled on different availability zones. Changing this
               creates a new router.
        :param pulumi.Input[_builtins.str] description: Human-readable description for the router.
        :param pulumi.Input[_builtins.bool] distributed: Indicates whether or not to create a
        ...
        :param pulumi.Input[_builtins.str] external_network_id: The network UUID of an external gateway
               for the router. A router with an external gateway is required if any
               compute instances or load balancers will be using floating IPs. Changing
               this updates the external gateway of the router.
        :param pulumi.Input[_builtins.str] external_qos_policy_id: The QoS policy UUID that will be applied
               on the external gateway for the router. Changing this updates the external
               gateway of the router.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] external_subnet_ids: A list of external subnet IDs to try over
        ...
        :param pulumi.Input[_builtins.str] name: A unique name for the router. Changing this
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to obtain the V2 networking client.
               ...
               router.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: A set of string tags for the router.
        :param pulumi.Input[_builtins.str] tenant_id: The owner of the floating IP. Required if admin wants
...
class _RouterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] admin_state_up: Administrative up/down status for the router
               (must be "true" or "false" if provided). Changing this updates the
               `admin_state_up` of an existing router.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] all_tags: The collection of tags assigned on the router, which have been
...
class Router(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 distributed: pulumi.Input[Optional[_builtins.bool]] = None,
                 enable_snat: pulumi.Input[Optional[_builtins.bool]] = None,
                 external_fixed_ips: pulumi.Input[Optional[Sequence[pulumi.Input[Union['RouterExternalFixedIpArgs', 'RouterExternalFixedIpArgsDict', 'outputs.RouterExternalFixedIp']]]]] = None,
                 external_network_id: pulumi.Input[Optional[_builtins.str]] = None,
                 external_qos_policy_id: pulumi.Input[Optional[_builtins.str]] = None,
                 external_subnet_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 tenant_id: pulumi.Input[Optional[_builtins.str]] = None,
                 value_specs: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 vendor_options: pulumi.Input[Optional[Union['RouterVendorOptionsArgs', 'RouterVendorOptionsArgsDict', 'outputs.RouterVendorOptions']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.bool] enable_snat: Enable Source NAT for the router. Valid values are
               ...
               Setting this value **requires** an **ext-gw-mode** extension to be enabled
               in OpenStack Neutron.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RouterExternalFixedIpArgs', 'RouterExternalFixedIpArgsDict', 'outputs.RouterExternalFixedIp']]]] external_fixed_ips: An external fixed IP for the router. This
               can be repeated. The structure is described below. An `external_network_id`
               has to be set in order to set this property. Changing this updates the
               external fixed IPs of the router.
        :param pulumi.Input[_builtins.str] external_network_id: The network UUID of an external gateway
        ...
        :param pulumi.Input[_builtins.str] tenant_id: The owner of the floating IP. Required if admin wants
               to create a router for another tenant. Changing this creates a new router.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] value_specs: Map of additional driver-specific options.
        :param pulumi.Input[Union['RouterVendorOptionsArgs', 'RouterVendorOptionsArgsDict', 'outputs.RouterVendorOptions']] vendor_options: Map of additional vendor-specific options.
               Supported options are described below.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            tenant_id: pulumi.Input[Optional[_builtins.str]] = None,
            value_specs: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            vendor_options: pulumi.Input[Optional[Union['RouterVendorOptionsArgs', 'RouterVendorOptionsArgsDict', 'outputs.RouterVendorOptions']]] = None) -> 'Router':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="availabilityZoneHints")
    def availability_zone_hints(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        An availability zone is used to make
        network resources highly available. Used for resources with high availability
        so that they are scheduled on different availability zones. Changing this
    ...
    @_builtins.property
    @pulumi.getter(name="externalQosPolicyId")
    def external_qos_policy_id(self) -> pulumi.Output[_builtins.str]:
        """
        The QoS policy UUID that will be applied
        on the external gateway for the router. Changing this updates the external
        gateway of the router.
    ...
    @_builtins.property
    @pulumi.getter(name="externalSubnetIds")
    def external_subnet_ids(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        A list of external subnet IDs to try over
        each to obtain a fixed IP for the router. If a subnet ID in a list has
        exhausted floating IP pool, the next subnet ID will be tried. This argument is
