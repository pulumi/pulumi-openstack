...
class TrunkArgs:
    def __init__(__self__, *,
                 ...
                 sub_ports: pulumi.Input[Optional[Sequence[pulumi.Input['TrunkSubPortArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] description: Human-readable description of the trunk. Changing this
               updates the name of the existing trunk.
        :param pulumi.Input[_builtins.str] name: A unique name for the trunk. Changing this
        ...
        :param pulumi.Input[_builtins.str] tenant_id: The owner of the Trunk. Required if admin wants
    ...
    def sub_ports(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['TrunkSubPortArgs']]]]:
        """
    ...
    @sub_ports.setter
    def sub_ports(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['TrunkSubPortArgs']]]]):
...
class _TrunkState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] admin_state_up: Administrative up/down status for the trunk
               (must be "true" or "false" if provided). Changing this updates the
               `admin_state_up` of an existing trunk.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] all_tags: The collection of tags assigned on the trunk, which have been
...
class Trunk(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 port_id: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 sub_ports: pulumi.Input[Optional[Sequence[pulumi.Input[Union['TrunkSubPortArgs', 'TrunkSubPortArgsDict', 'outputs.TrunkSubPort']]]]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 tenant_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to obtain the V2 networking client.
               ...
               `region` argument of the provider is used. Changing this creates a new
               trunk.
        :param pulumi.Input[Sequence[pulumi.Input[Union['TrunkSubPortArgs', 'TrunkSubPortArgsDict', 'outputs.TrunkSubPort']]]] sub_ports: The set of ports that will be made subports of the trunk.
               The structure of each subport is described below.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: A set of string tags for the port.
        :param pulumi.Input[_builtins.str] tenant_id: The owner of the Trunk. Required if admin wants
               to create a trunk on behalf of another tenant. Changing this creates a new trunk.
    ...
    def get(resource_name: str,
            ...
            sub_ports: pulumi.Input[Optional[Sequence[pulumi.Input[Union['TrunkSubPortArgs', 'TrunkSubPortArgsDict', 'outputs.TrunkSubPort']]]]] = None,
            tags: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            tenant_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'Trunk':
        """
