...
def get_port_ids(admin_state_up: Optional[builtins.bool] = None,
    ...
    :param builtins.str sort_direction: Order the results in either `asc` or `desc`.
           Defaults to none.
    :param builtins.str sort_key: Sort ports based on a certain key. Defaults to none.
...
def get_port_ids_output(admin_state_up: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
