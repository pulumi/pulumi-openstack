...
class OrderV1Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The type of key to be generated. Must be one of `asymmetric`, `key`.
...
class _OrderV1State:
    def __init__(__self__, *,
                 container_ref: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 order_ref: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 secret_ref: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 sub_status: Optional[pulumi.Input[builtins.str]] = None,
                 sub_status_message: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] container_ref: The container reference / where to find the container.
        :param pulumi.Input[builtins.str] created: The date the order was created.
        :param pulumi.Input[builtins.str] creator_id: The creator of the order.
        :param pulumi.Input['OrderV1MetaArgs'] meta: Dictionary containing the order metadata used to generate the order. The structure is described below.
        :param pulumi.Input[builtins.str] order_ref: The order reference / where to find the order.
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V1 KeyManager client.
               A KeyManager client is needed to create a order. If omitted, the
               `region` argument of the provider is used. Changing this creates a new
               V1 order.
        :param pulumi.Input[builtins.str] secret_ref: The secret reference / where to find the secret.
        :param pulumi.Input[builtins.str] status: The status of the order.
        :param pulumi.Input[builtins.str] sub_status: The sub status of the order.
        :param pulumi.Input[builtins.str] sub_status_message: The sub status message of the order.
        :param pulumi.Input[builtins.str] type: The type of key to be generated. Must be one of `asymmetric`, `key`.
        :param pulumi.Input[builtins.str] updated: The date the order was last updated.
        """
    ...
    def container_ref(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def container_ref(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def order_ref(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @order_ref.setter
    def order_ref(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sub_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sub_status.setter
    def sub_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sub_status", value)

    @property
    @pulumi.getter(name="subStatusMessage")
    def sub_status_message(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sub_status_message(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OrderV1(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sub_status_message: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            updated: Optional[pulumi.Input[builtins.str]] = None) -> 'OrderV1':
        """
    ...
    @property
    @pulumi.getter(name="containerRef")
    def container_ref(self) -> pulumi.Output[builtins.str]:
        """
        The container reference / where to find the container.
        """
        return pulumi.get(self, "container_ref")
    ...
    @property
    @pulumi.getter(name="orderRef")
    def order_ref(self) -> pulumi.Output[builtins.str]:
        """
        The order reference / where to find the order.
        """
        return pulumi.get(self, "order_ref")
    ...
    @property
    @pulumi.getter(name="subStatus")
    def sub_status(self) -> pulumi.Output[builtins.str]:
        """
        The sub status of the order.
        """
        return pulumi.get(self, "sub_status")
    ...
    @property
    @pulumi.getter(name="subStatusMessage")
    def sub_status_message(self) -> pulumi.Output[builtins.str]:
        """
        The sub status message of the order.
        """
        return pulumi.get(self, "sub_status_message")
