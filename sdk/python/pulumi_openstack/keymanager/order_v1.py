...
class _OrderV1State:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] status: The status of the order.
        :param pulumi.Input[_builtins.str] sub_status: The sub status of the order.
        :param pulumi.Input[_builtins.str] sub_status_message: The sub status message of the order.
        :param pulumi.Input[_builtins.str] type: The type of key to be generated. Must be one of `asymmetric`, `key`.
        :param pulumi.Input[_builtins.str] updated: The date the order was last updated.
        """
...
class OrderV1(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="orderRef")
    def order_ref(self) -> pulumi.Output[_builtins.str]:
        """
        The order reference / where to find the order.
        """
        return pulumi.get(self, "order_ref")
    ...
    @_builtins.property
    @pulumi.getter(name="subStatusMessage")
    def sub_status_message(self) -> pulumi.Output[_builtins.str]:
        """
        The sub status message of the order.
        """
        return pulumi.get(self, "sub_status_message")
