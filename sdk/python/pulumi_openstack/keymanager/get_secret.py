...
class GetSecretResult:
    ...
    def acl_only(self) -> Optional[builtins.bool]:
        """
    ...
    def bit_length(self) -> Optional[builtins.int]:
        """
        See Argument Reference above.
        """
    ...
    def content_types(self) -> Mapping[str, builtins.str]:
        """
    ...
    def created_at_filter(self) -> Optional[builtins.str]:
        """
        See Argument Reference above.
        """
    ...
    def expiration_filter(self) -> Optional[builtins.str]:
        """
        See Argument Reference above.
        """
    ...
    def updated_at_filter(self) -> Optional[builtins.str]:
        """
        See Argument Reference above.
        """
...
def get_secret(acl_only: Optional[builtins.bool] = None,
               algorithm: Optional[builtins.str] = None,
               bit_length: Optional[builtins.int] = None,
               created_at_filter: Optional[builtins.str] = None,
               expiration_filter: Optional[builtins.str] = None,
               mode: Optional[builtins.str] = None,
               name: Optional[builtins.str] = None,
               region: Optional[builtins.str] = None,
               secret_type: Optional[builtins.str] = None,
               updated_at_filter: Optional[builtins.str] = None,
    ...
    :param builtins.bool acl_only: Select the Secret with an ACL that contains the user.
           Project scope is ignored. Defaults to `false`.
    :param builtins.str algorithm: The Secret algorithm.
    :param builtins.int bit_length: The Secret bit length.
    :param builtins.str created_at_filter: Date filter to select the Secret with
           created matching the specified criteria. See Date Filters below for more
           detail.
    :param builtins.str expiration_filter: Date filter to select the Secret with
           expiration matching the specified criteria. See Date Filters below for more
           detail.
    :param builtins.str mode: The Secret mode.
    :param builtins.str name: The Secret name.
    :param builtins.str region: The region in which to obtain the V1 KeyManager client.
           A KeyManager client is needed to fetch a secret. If omitted, the `region`
           argument of the provider is used.
    :param builtins.str secret_type: The Secret type. For more information see
           [Secret types](https://docs.openstack.org/barbican/latest/api/reference/secret_types.html).
    :param builtins.str updated_at_filter: Date filter to select the Secret with
...
def get_secret_output(acl_only: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                      algorithm: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      bit_length: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                      created_at_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      expiration_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      mode: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      secret_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      updated_at_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
