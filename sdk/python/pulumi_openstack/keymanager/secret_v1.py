...
class SecretV1Args:
    def __init__(__self__, *,
                 ...
                 bit_length: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 payload_content_encoding: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['SecretV1AclArgs'] acl: Allows to control an access to a secret. Currently only the
               ...
               project wide.
        :param pulumi.Input[builtins.str] algorithm: Metadata provided by a user or system for informational purposes.
        :param pulumi.Input[builtins.int] bit_length: Metadata provided by a user or system for informational purposes.
        :param pulumi.Input[builtins.str] expiration: The expiration time of the secret in the RFC3339 timestamp format (e.g. `2019-03-09T12:58:49Z`). If omitted, a secret will never expire. Changing this creates a new secret.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Additional Metadata for the secret.
        :param pulumi.Input[builtins.str] mode: Metadata provided by a user or system for informational purposes.
        :param pulumi.Input[builtins.str] name: Human-readable name for the Secret. Does not have
               to be unique.
        :param pulumi.Input[builtins.str] payload: The secret's data to be stored. **payload\\_content\\_type** must also be supplied if **payload** is included.
        :param pulumi.Input[builtins.str] payload_content_encoding: (required if **payload** is encoded) The encoding used for the payload to be able to include it in the JSON request. Must be either `base64` or `binary`.
        :param pulumi.Input[builtins.str] payload_content_type: (required if **payload** is included) The media type for the content of the payload. Must be one of `text/plain`, `text/plain;charset=utf-8`, `text/plain; charset=utf-8`, `application/octet-stream`, `application/pkcs8`.
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V1 KeyManager client.
               A KeyManager client is needed to create a secret. If omitted, the
               `region` argument of the provider is used. Changing this creates a new
               V1 secret.
        :param pulumi.Input[builtins.str] secret_type: Used to indicate the type of secret being stored. For more information see [Secret types](https://docs.openstack.org/barbican/latest/api/reference/secret_types.html).
        """
        if acl is not None:
    ...
    def bit_length(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Metadata provided by a user or system for informational purposes.
        """
    ...
    @bit_length.setter
    def bit_length(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def payload_content_encoding(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def payload_content_encoding(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SecretV1State:
    def __init__(__self__, *,
                 ...
                 bit_length: Optional[pulumi.Input[builtins.int]] = None,
                 content_types: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input['SecretV1AclArgs'] acl: Allows to control an access to a secret. Currently only the
               ...
               project wide.
        :param pulumi.Input[builtins.str] algorithm: Metadata provided by a user or system for informational purposes.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] all_metadata: The map of metadata, assigned on the secret, which has been
               explicitly and implicitly added.
        :param pulumi.Input[builtins.int] bit_length: Metadata provided by a user or system for informational purposes.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] content_types: The map of the content types, assigned on the secret.
        :param pulumi.Input[builtins.str] created_at: The date the secret was created.
        :param pulumi.Input[builtins.str] creator_id: The creator of the secret.
        :param pulumi.Input[builtins.str] expiration: The expiration time of the secret in the RFC3339 timestamp format (e.g. `2019-03-09T12:58:49Z`). If omitted, a secret will never expire. Changing this creates a new secret.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Additional Metadata for the secret.
        :param pulumi.Input[builtins.str] mode: Metadata provided by a user or system for informational purposes.
        :param pulumi.Input[builtins.str] name: Human-readable name for the Secret. Does not have
        ...
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V1 KeyManager client.
               ...
               `region` argument of the provider is used. Changing this creates a new
               V1 secret.
        :param pulumi.Input[builtins.str] secret_ref: The secret reference / where to find the secret.
        :param pulumi.Input[builtins.str] secret_type: Used to indicate the type of secret being stored. For more information see [Secret types](https://docs.openstack.org/barbican/latest/api/reference/secret_types.html).
        :param pulumi.Input[builtins.str] status: The status of the secret.
    ...
    def content_types(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def content_types(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class SecretV1(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secret_type: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'SecretV1':
        """
    ...
    @property
    @pulumi.getter(name="bitLength")
    def bit_length(self) -> pulumi.Output[builtins.int]:
        """
        Metadata provided by a user or system for informational purposes.
        """
        return pulumi.get(self, "bit_length")
    ...
    @property
    @pulumi.getter(name="contentTypes")
    def content_types(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        The map of the content types, assigned on the secret.
        """
        return pulumi.get(self, "content_types")
    ...
    @property
    @pulumi.getter(name="payloadContentEncoding")
    def payload_content_encoding(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (required if **payload** is encoded) The encoding used for the payload to be able to include it in the JSON request. Must be either `base64` or `binary`.
        """
        return pulumi.get(self, "payload_content_encoding")
    ...
    @property
    @pulumi.getter(name="payloadContentType")
    def payload_content_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (required if **payload** is included) The media type for the content of the payload. Must be one of `text/plain`, `text/plain;charset=utf-8`, `text/plain; charset=utf-8`, `application/octet-stream`, `application/pkcs8`.
        """
        return pulumi.get(self, "payload_content_type")
    ...
    @property
    @pulumi.getter(name="secretRef")
    def secret_ref(self) -> pulumi.Output[builtins.str]:
        """
        The secret reference / where to find the secret.
        """
        return pulumi.get(self, "secret_ref")
