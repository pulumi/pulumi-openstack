...
class SiteConnectionArgs:
    def __init__(__self__, *,
                 ikepolicy_id: pulumi.Input[builtins.str],
                 ipsecpolicy_id: pulumi.Input[builtins.str],
                 peer_address: pulumi.Input[builtins.str],
                 peer_id: pulumi.Input[builtins.str],
                 psk: pulumi.Input[builtins.str],
                 vpnservice_id: pulumi.Input[builtins.str],
                 ...
                 initiator: Optional[pulumi.Input[builtins.str]] = None,
                 local_ep_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 local_id: Optional[pulumi.Input[builtins.str]] = None,
                 mtu: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 peer_cidrs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 peer_ep_group_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] ikepolicy_id: The ID of the IKE policy. Changing this creates a new connection.
        :param pulumi.Input[builtins.str] ipsecpolicy_id: The ID of the IPsec policy. Changing this creates a new connection.
        :param pulumi.Input[builtins.str] peer_address: The peer gateway public IPv4 or IPv6 address or FQDN.
        :param pulumi.Input[builtins.str] peer_id: The peer router identity for authentication. A valid value is an IPv4 address, IPv6 address, e-mail address, key ID, or FQDN.
               Typically, this value matches the peer_address value.
               Changing this updates the existing policy.
        :param pulumi.Input[builtins.str] psk: The pre-shared key. A valid value is any string.
        :param pulumi.Input[builtins.str] vpnservice_id: The ID of the VPN service. Changing this creates a new connection.
        :param pulumi.Input[builtins.bool] admin_state_up: The administrative state of the resource. Can either be up(true) or down(false).
               Changing this updates the administrative state of the existing connection.
        :param pulumi.Input[builtins.str] description: The human-readable description for the connection.
        ...
        :param pulumi.Input[builtins.str] initiator: A valid value is response-only or bi-directional. Default is bi-directional.
        :param pulumi.Input[builtins.str] local_ep_group_id: The ID for the endpoint group that contains private subnets for the local side of the connection.
               You must specify this parameter with the peer_ep_group_id parameter unless
               in backward- compatible mode where peer_cidrs is provided with a subnet_id for the VPN service.
               Changing this updates the existing connection.
        :param pulumi.Input[builtins.str] local_id: An ID to be used instead of the external IP address for a virtual router used in traffic between instances on different networks in east-west traffic.
               Most often, local ID would be domain name, email address, etc.
               If this is not configured then the external IP address will be used as the ID.
        :param pulumi.Input[builtins.int] mtu: The maximum transmission unit (MTU) value to address fragmentation.
               Minimum value is 68 for IPv4, and 1280 for IPv6.
        :param pulumi.Input[builtins.str] name: The name of the connection. Changing this updates the name of
               the existing connection.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] peer_cidrs: Unique list of valid peer private CIDRs in the form < net_address > / < prefix > .
        :param pulumi.Input[builtins.str] peer_ep_group_id: The ID for the endpoint group that contains private CIDRs in the form < net_address > / < prefix > for the peer side of the connection.
        ...
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V2 Networking client.
               ...
               site connection.
        :param pulumi.Input[builtins.str] tenant_id: The owner of the connection. Required if admin wants to
    ...
    def ikepolicy_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ikepolicy_id.setter
    def ikepolicy_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ikepolicy_id", value)

    @property
    @pulumi.getter(name="ipsecpolicyId")
    def ipsecpolicy_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ipsecpolicy_id(self, value: pulumi.Input[builtins.str]):
    ...
    def peer_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @peer_id.setter
    def peer_id(self, value: pulumi.Input[builtins.str]):
    ...
    def vpnservice_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vpnservice_id(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter
    def initiator(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @initiator.setter
    def initiator(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "initiator", value)

    @property
    @pulumi.getter(name="localEpGroupId")
    def local_ep_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def local_ep_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def peer_cidrs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @peer_cidrs.setter
    def peer_cidrs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "peer_cidrs", value)

    @property
    @pulumi.getter(name="peerEpGroupId")
    def peer_ep_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peer_ep_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SiteConnectionState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 dpds: Optional[pulumi.Input[Sequence[pulumi.Input['SiteConnectionDpdArgs']]]] = None,
                 ikepolicy_id: Optional[pulumi.Input[builtins.str]] = None,
                 initiator: Optional[pulumi.Input[builtins.str]] = None,
                 ipsecpolicy_id: Optional[pulumi.Input[builtins.str]] = None,
                 local_ep_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 local_id: Optional[pulumi.Input[builtins.str]] = None,
                 mtu: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None,
                 value_specs: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 vpnservice_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="ikepolicyId")
    def ikepolicy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the IKE policy. Changing this creates a new connection.
        """
        return pulumi.get(self, "ikepolicy_id")
    ...
    @ikepolicy_id.setter
    def ikepolicy_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ikepolicy_id", value)
    ...
    @property
    @pulumi.getter(name="ipsecpolicyId")
    def ipsecpolicy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the IPsec policy. Changing this creates a new connection.
        """
        return pulumi.get(self, "ipsecpolicy_id")
    ...
    @ipsecpolicy_id.setter
    def ipsecpolicy_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipsecpolicy_id", value)
    ...
    @property
    @pulumi.getter(name="vpnserviceId")
    def vpnservice_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the VPN service. Changing this creates a new connection.
        """
        return pulumi.get(self, "vpnservice_id")
    ...
    @vpnservice_id.setter
    def vpnservice_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vpnservice_id", value)
...
class SiteConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            value_specs: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpnservice_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SiteConnection':
        """
    ...
    @property
    @pulumi.getter(name="ikepolicyId")
    def ikepolicy_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the IKE policy. Changing this creates a new connection.
        """
        return pulumi.get(self, "ikepolicy_id")
    ...
    @property
    @pulumi.getter
    def initiator(self) -> pulumi.Output[builtins.str]:
        """
        A valid value is response-only or bi-directional. Default is bi-directional.
        """
        return pulumi.get(self, "initiator")
    ...
    @property
    @pulumi.getter(name="ipsecpolicyId")
    def ipsecpolicy_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the IPsec policy. Changing this creates a new connection.
        """
        return pulumi.get(self, "ipsecpolicy_id")
    ...
    @property
    @pulumi.getter(name="localEpGroupId")
    def local_ep_group_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID for the endpoint group that contains private subnets for the local side of the connection.
        You must specify this parameter with the peer_ep_group_id parameter unless
        in backward- compatible mode where peer_cidrs is provided with a subnet_id for the VPN service.
    ...
    @property
    @pulumi.getter(name="localId")
    def local_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An ID to be used instead of the external IP address for a virtual router used in traffic between instances on different networks in east-west traffic.
        Most often, local ID would be domain name, email address, etc.
        If this is not configured then the external IP address will be used as the ID.
    ...
    @property
    @pulumi.getter(name="peerCidrs")
    def peer_cidrs(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Unique list of valid peer private CIDRs in the form < net_address > / < prefix > .
        """
        return pulumi.get(self, "peer_cidrs")
    ...
    @property
    @pulumi.getter(name="peerEpGroupId")
    def peer_ep_group_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID for the endpoint group that contains private CIDRs in the form < net_address > / < prefix > for the peer side of the connection.
        You must specify this parameter with the local_ep_group_id parameter unless in backward-compatible mode
        where peer_cidrs is provided with a subnet_id for the VPN service.
    ...
    @property
    @pulumi.getter(name="vpnserviceId")
    def vpnservice_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the VPN service. Changing this creates a new connection.
        """
        return pulumi.get(self, "vpnservice_id")
