...
class IpSecPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] encapsulation_mode: The encapsulation mode. Valid values are tunnel and transport. Default is tunnel.
        ...
        :param pulumi.Input[_builtins.str] transform_protocol: The transform protocol. Valid values are esp, ah and ah-esp.
...
class IpSecPolicy(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="authAlgorithm")
    def auth_algorithm(self) -> pulumi.Output[_builtins.str]:
        """
        The authentication hash algorithm. Valid values are sha1, sha256, sha384, sha512,
        aes-xcbc, aes-cmac. Default is sha1.
        Changing this updates the algorithm of the existing policy.
