...
class ServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] router_id: The ID of the router. Changing this creates a new service.
        ...
        :param pulumi.Input[builtins.str] description: The human-readable description for the service.
               Changing this updates the description of the existing service.
        :param pulumi.Input[builtins.str] name: The name of the service. Changing this updates the name of
        ...
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V2 Networking client.
               ...
               service.
        :param pulumi.Input[builtins.str] subnet_id: SubnetID is the ID of the subnet. Default is null.
        :param pulumi.Input[builtins.str] tenant_id: The owner of the service. Required if admin wants to
...
class _ServiceState:
    def __init__(__self__, *,
                 admin_state_up: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 external_v4_ip: Optional[pulumi.Input[builtins.str]] = None,
                 external_v6_ip: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The human-readable description for the service.
               Changing this updates the description of the existing service.
        :param pulumi.Input[builtins.str] external_v4_ip: The read-only external (public) IPv4 address that is used for the VPN service.
        :param pulumi.Input[builtins.str] external_v6_ip: The read-only external (public) IPv6 address that is used for the VPN service.
        :param pulumi.Input[builtins.str] name: The name of the service. Changing this updates the name of
               the existing service.
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V2 Networking client.
               A Networking client is needed to create a VPN service. If omitted, the
               ...
               service.
        :param pulumi.Input[builtins.str] router_id: The ID of the router. Changing this creates a new service.
        :param pulumi.Input[builtins.str] status: Indicates whether IPsec VPN service is currently operational. Values are ACTIVE, DOWN, BUILD, ERROR, PENDING_CREATE, PENDING_UPDATE, or PENDING_DELETE.
        :param pulumi.Input[builtins.str] subnet_id: SubnetID is the ID of the subnet. Default is null.
        :param pulumi.Input[builtins.str] tenant_id: The owner of the service. Required if admin wants to
               create a service for another project. Changing this creates a new service.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] value_specs: Map of additional options.
    ...
    def external_v4_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def external_v4_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "external_v4_ip", value)

    @property
    @pulumi.getter(name="externalV6Ip")
    def external_v6_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def external_v6_ip(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("openstack:vpnaas/service:Service")
class Service(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            subnet_id: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            value_specs: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Service':
        """
    ...
    @property
    @pulumi.getter(name="externalV4Ip")
    def external_v4_ip(self) -> pulumi.Output[builtins.str]:
        """
        The read-only external (public) IPv4 address that is used for the VPN service.
        """
        return pulumi.get(self, "external_v4_ip")
    ...
    @property
    @pulumi.getter(name="externalV6Ip")
    def external_v6_ip(self) -> pulumi.Output[builtins.str]:
        """
        The read-only external (public) IPv6 address that is used for the VPN service.
        """
        return pulumi.get(self, "external_v6_ip")
