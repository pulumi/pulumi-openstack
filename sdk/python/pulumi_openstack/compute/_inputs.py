...
if not MYPY:
    class InstanceBlockDeviceArgsDict(TypedDict):
        ...
        server.
        """
        boot_index: NotRequired[pulumi.Input[int]]
        """
        ...
        """
        guest_format: NotRequired[pulumi.Input[str]]
        """
        ...
        """
        multiattach: NotRequired[pulumi.Input[bool]]
        """
...
if not MYPY:
    class InstanceNetworkArgsDict(TypedDict):
        access_network: NotRequired[pulumi.Input[bool]]
        """
...
if not MYPY:
    class InstanceSchedulerHintArgsDict(TypedDict):
        ...
        """
        build_near_host_ip: NotRequired[pulumi.Input[str]]
        """
        An IP Address in CIDR form. The instance
        will be placed on a compute node that is in the same subnet.
        """
        different_cells: NotRequired[pulumi.Input[Sequence[pulumi.Input[str]]]]
        """
        ...
        """
        target_cell: NotRequired[pulumi.Input[str]]
        """
...
if not MYPY:
    class InstanceVendorOptionsArgsDict(TypedDict):
        detach_ports_before_destroy: NotRequired[pulumi.Input[bool]]
        """
        ...
        """
        ignore_resize_confirmation: NotRequired[pulumi.Input[bool]]
        """
...
if not MYPY:
    class ServerGroupRulesArgsDict(TypedDict):
        max_server_per_host: NotRequired[pulumi.Input[int]]
elif False:
...
if not MYPY:
    class VolumeAttachVendorOptionsArgsDict(TypedDict):
        ignore_volume_confirmation: NotRequired[pulumi.Input[bool]]
        """
        Boolean to control whether
