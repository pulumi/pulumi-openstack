...
class GetFlavorResult:
    ...
    def extra_specs(self) -> Mapping[str, builtins.str]:
        """
    ...
    def min_ram(self) -> Optional[builtins.int]:
    ...
    @property
    @pulumi.getter
    def ram(self) -> Optional[builtins.int]:
    ...
    def rx_tx_factor(self) -> Optional[builtins.float]:
...
def get_flavor(description: Optional[builtins.str] = None,
               ...
               min_ram: Optional[builtins.int] = None,
               name: Optional[builtins.str] = None,
               ram: Optional[builtins.int] = None,
               region: Optional[builtins.str] = None,
               rx_tx_factor: Optional[builtins.float] = None,
    ...
    :param builtins.str description: The description of the flavor.
    :param builtins.int disk: The exact amount of disk (in gigabytes).
    :param builtins.str flavor_id: The ID of the flavor. Conflicts with the `name`,
           `min_ram` and `min_disk`
    :param builtins.bool is_public: The flavor visibility.
    :param builtins.int min_disk: The minimum amount of disk (in gigabytes). Conflicts
           with the `flavor_id`.
    :param builtins.int min_ram: The minimum amount of RAM (in megabytes). Conflicts
           with the `flavor_id`.
    :param builtins.str name: The name of the flavor. Conflicts with the `flavor_id`.
    :param builtins.int ram: The exact amount of RAM (in megabytes).
    :param builtins.str region: The region in which to obtain the V2 Compute client.
           If omitted, the `region` argument of the provider is used.
    :param builtins.float rx_tx_factor: The `rx_tx_factor` of the flavor.
    :param builtins.int swap: The amount of swap (in gigabytes).
    :param builtins.int vcpus: The amount of VCPUs.
    """
    __args__ = dict()
...
def get_flavor_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      disk: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                      flavor_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      is_public: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                      min_disk: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                      min_ram: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                      name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      ram: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                      region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      rx_tx_factor: Optional[pulumi.Input[Optional[builtins.float]]] = None,
                      swap: Optional[pulumi.Input[Optional[builtins.int]]] = None,
