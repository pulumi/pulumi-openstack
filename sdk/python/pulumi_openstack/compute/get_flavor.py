...
class GetFlavorResult:
    ...
    def rx_tx_factor(self) -> Optional[_builtins.float]:
...
def get_flavor(description: Optional[_builtins.str] = None,
               ...
               rx_tx_factor: Optional[_builtins.float] = None,
    ...
    :param _builtins.str description: The description of the flavor.
    :param _builtins.int disk: The exact amount of disk (in gigabytes).
    :param _builtins.str flavor_id: The ID of the flavor. Conflicts with the `name`,
           `min_ram` and `min_disk`
    :param _builtins.bool is_public: The flavor visibility.
    :param _builtins.int min_disk: The minimum amount of disk (in gigabytes). Conflicts
           with the `flavor_id`.
    :param _builtins.int min_ram: The minimum amount of RAM (in megabytes). Conflicts
           with the `flavor_id`.
    :param _builtins.str name: The name of the flavor. Conflicts with the `flavor_id`.
    :param _builtins.int ram: The exact amount of RAM (in megabytes).
    :param _builtins.str region: The region in which to obtain the V2 Compute client.
           If omitted, the `region` argument of the provider is used.
    :param _builtins.float rx_tx_factor: The `rx_tx_factor` of the flavor.
    :param _builtins.int swap: The amount of swap (in gigabytes).
    :param _builtins.int vcpus: The amount of VCPUs.
    """
    __args__ = dict()
...
def get_flavor_output(description: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                      disk: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                      flavor_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                      is_public: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                      min_disk: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                      min_ram: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                      name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                      ram: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                      region: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                      rx_tx_factor: pulumi.Input[Optional[Optional[_builtins.float]]] = None,
                      swap: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                      vcpus: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
