...
class GetQuotaSetV2Result:
    ...
    def fixed_ips(self) -> builtins.int:
        """
    ...
    def floating_ips(self) -> builtins.int:
        """
    ...
    def injected_file_content_bytes(self) -> builtins.int:
        """
    ...
    def injected_file_path_bytes(self) -> builtins.int:
        """
    ...
    def injected_files(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter
    def instances(self) -> builtins.int:
        """
    ...
    def key_pairs(self) -> builtins.int:
        """
    ...
    def metadata_items(self) -> builtins.int:
        """
    ...
    def security_group_rules(self) -> builtins.int:
        """
    ...
    def security_groups(self) -> builtins.int:
        """
    ...
    def server_group_members(self) -> builtins.int:
        """
    ...
    def server_groups(self) -> builtins.int:
        """
...
def get_quota_set_v2(project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str project_id: The id of the project to retrieve the quotaset.
...
def get_quota_set_v2_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
