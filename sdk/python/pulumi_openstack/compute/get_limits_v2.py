...
def get_limits_v2(project_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str project_id: The id of the project to retrieve the limits.
...
def get_limits_v2_output(project_id: Optional[pulumi.Input[_builtins.str]] = None,
