...
class VolumeAttachArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: The ID of the Instance to attach the Volume to.
        :param pulumi.Input[builtins.str] volume_id: The ID of the Volume to attach to an Instance.
        :param pulumi.Input[builtins.bool] multiattach: Enable attachment of multiattach-capable volumes.
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V2 Compute client.
               A Compute client is needed to create a volume attachment. If omitted, the
               `region` argument of the provider is used. Changing this creates a
               new volume attachment.
        :param pulumi.Input[builtins.str] tag: Add a device role tag that is applied to the volume when
...
class VolumeAttach(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tag: Optional[pulumi.Input[builtins.str]] = None,
            vendor_options: Optional[pulumi.Input[Union['VolumeAttachVendorOptionsArgs', 'VolumeAttachVendorOptionsArgsDict']]] = None,
            volume_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VolumeAttach':
        """
