...
class GetShareNetworkResult:
    ...
    def security_service_id(self) -> Optional[builtins.str]:
        """
        See Argument Reference above.
        """
    ...
    def security_service_ids(self) -> Sequence[builtins.str]:
        """
...
def get_share_network(description: Optional[builtins.str] = None,
                      ip_version: Optional[builtins.int] = None,
                      name: Optional[builtins.str] = None,
                      network_type: Optional[builtins.str] = None,
                      neutron_net_id: Optional[builtins.str] = None,
                      neutron_subnet_id: Optional[builtins.str] = None,
                      region: Optional[builtins.str] = None,
                      security_service_id: Optional[builtins.str] = None,
    ...
    :param builtins.str description: The human-readable description of the share network.
    :param builtins.int ip_version: The IP version of the share network. Can either be 4 or 6.
    :param builtins.str name: The name of the share network.
    :param builtins.str network_type: The share network type. Can either be VLAN, VXLAN,
           GRE, or flat.
    :param builtins.str neutron_net_id: The neutron network UUID of the share network.
    :param builtins.str neutron_subnet_id: The neutron subnet UUID of the share network.
    ...
    :param builtins.str security_service_id: The security service IDs associated with
           the share network.
    :param builtins.int segmentation_id: The share network segmentation ID.
    """
    __args__ = dict()
...
def get_share_network_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             ...
                             neutron_net_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             neutron_subnet_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             security_service_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
