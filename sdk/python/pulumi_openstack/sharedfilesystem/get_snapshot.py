...
class GetSnapshotResult:
    ...
    def share_size(self) -> builtins.int:
        """
...
def get_snapshot(description: Optional[builtins.str] = None,
    ...
    :param builtins.str description: The human-readable description of the snapshot.
    ...
    :param builtins.str share_id: The UUID of the source share that was used to create the snapshot.
    :param builtins.str status: A snapshot status filter. A valid value is `available`, `error`,
...
def get_snapshot_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
