...
class GetSnapshotResult:
    ...
    def share_size(self) -> _builtins.int:
        """
...
def get_snapshot(description: Optional[_builtins.str] = None,
    ...
    :param _builtins.str description: The human-readable description of the snapshot.
    ...
    :param _builtins.str share_id: The UUID of the source share that was used to create the snapshot.
    :param _builtins.str status: A snapshot status filter. A valid value is `available`, `error`,
