...
class ShareArgs:
    def __init__(__self__, *,
                 share_proto: pulumi.Input[builtins.str],
                 ...
                 share_network_id: Optional[pulumi.Input[builtins.str]] = None,
                 share_type: Optional[pulumi.Input[builtins.str]] = None,
                 snapshot_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Share resource.
        :param pulumi.Input[builtins.str] share_proto: The share protocol - can either be NFS, CIFS,
               CEPHFS, GLUSTERFS, HDFS or MAPRFS. Changing this creates a new share.
        :param pulumi.Input[builtins.int] size: The share size, in GBs. The requested share size cannot be greater
               than the allowed GB quota. Changing this resizes the existing share.
        :param pulumi.Input[builtins.str] availability_zone: The share availability zone. Changing this creates a
               new share.
        :param pulumi.Input[builtins.str] description: The human-readable description for the share.
               Changing this updates the description of the existing share.
        :param pulumi.Input[builtins.bool] is_public: The level of visibility for the share. Set to true to make
               share public. Set to false to make it private. Default value is false. Changing this
               updates the existing share.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: One or more metadata key and value pairs as a dictionary of
               strings.
        ...
        :param pulumi.Input[builtins.str] share_type: The share type name. If you omit this parameter, the default
               share type is used.
        :param pulumi.Input[builtins.str] snapshot_id: The UUID of the share's base snapshot. Changing this creates
               a new share.
        """
    ...
    def share_proto(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @share_proto.setter
    def share_proto(self, value: pulumi.Input[builtins.str]):
    ...
    def share_network_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def share_network_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ShareState:
    def __init__(__self__, *,
                 ...
                 has_replicas: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 share_server_id: Optional[pulumi.Input[builtins.str]] = None,
                 share_type: Optional[pulumi.Input[builtins.str]] = None,
                 size: Optional[pulumi.Input[builtins.int]] = None,
                 snapshot_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Share resources.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] all_metadata: The map of metadata, assigned on the share, which has been
        ...
        :param pulumi.Input[builtins.bool] has_replicas: Indicates whether a share has replicas or not.
        :param pulumi.Input[builtins.str] host: The share host name.
        :param pulumi.Input[builtins.bool] is_public: The level of visibility for the share. Set to true to make
               share public. Set to false to make it private. Default value is false. Changing this
               updates the existing share.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: One or more metadata key and value pairs as a dictionary of
        ...
        :param pulumi.Input[builtins.str] share_proto: The share protocol - can either be NFS, CIFS,
               CEPHFS, GLUSTERFS, HDFS or MAPRFS. Changing this creates a new share.
        :param pulumi.Input[builtins.str] share_server_id: The UUID of the share server.
        :param pulumi.Input[builtins.str] share_type: The share type name. If you omit this parameter, the default
               share type is used.
        :param pulumi.Input[builtins.int] size: The share size, in GBs. The requested share size cannot be greater
               than the allowed GB quota. Changing this resizes the existing share.
    ...
    def has_replicas(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @has_replicas.setter
    def has_replicas(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def share_server_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def share_server_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Share(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            share_type: Optional[pulumi.Input[builtins.str]] = None,
            size: Optional[pulumi.Input[builtins.int]] = None,
            snapshot_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Share':
        """
    ...
    @property
    @pulumi.getter(name="hasReplicas")
    def has_replicas(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether a share has replicas or not.
        """
        return pulumi.get(self, "has_replicas")
    ...
    @property
    @pulumi.getter(name="shareNetworkId")
    def share_network_id(self) -> pulumi.Output[builtins.str]:
        """
        The UUID of a share network where the share server exists
        or will be created. If `share_network_id` is not set and you provide a `snapshot_id`,
        the share_network_id value from the snapshot is used. Changing this creates a new share.
    ...
    @property
    @pulumi.getter(name="shareProto")
    def share_proto(self) -> pulumi.Output[builtins.str]:
        """
        The share protocol - can either be NFS, CIFS,
        CEPHFS, GLUSTERFS, HDFS or MAPRFS. Changing this creates a new share.
        """
    ...
    @property
    @pulumi.getter(name="shareServerId")
    def share_server_id(self) -> pulumi.Output[builtins.str]:
        """
        The UUID of the share server.
        """
        return pulumi.get(self, "share_server_id")
