...
class SecurityServiceArgs:
    def __init__(__self__, *,
                 ...
                 dns_ip: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] dns_ip: The security service DNS IP address that is used inside the
               tenant network.
        :param pulumi.Input[_builtins.str] domain: The security service domain.
        :param pulumi.Input[_builtins.str] name: The name of the security service. Changing this updates the name
               of the existing security service.
        :param pulumi.Input[_builtins.str] ou: The security service ou. An organizational unit can be added to
               specify where the share ends up. New in Manila microversion 2.44.
        :param pulumi.Input[_builtins.str] password: The user password, if you specify a user.
        :param pulumi.Input[_builtins.str] region: The region in which to obtain the V2 Shared File System client.
               ...
               security service.
        :param pulumi.Input[_builtins.str] server: The security service host name or IP address.
        :param pulumi.Input[_builtins.str] user: The security service user or group name that is used by the
               tenant.
        """
    ...
    def dns_ip(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @dns_ip.setter
    def dns_ip(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class _SecurityServiceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ou: The security service ou. An organizational unit can be added to
               specify where the share ends up. New in Manila microversion 2.44.
        :param pulumi.Input[_builtins.str] password: The user password, if you specify a user.
        :param pulumi.Input[_builtins.str] project_id: The owner of the Security Service.
        :param pulumi.Input[_builtins.str] region: The region in which to obtain the V2 Shared File System client.
               A Shared File System client is needed to create a security service. If omitted, the
               `region` argument of the provider is used. Changing this creates a new
               security service.
...
class SecurityService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            server: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            user: Optional[pulumi.Input[_builtins.str]] = None) -> 'SecurityService':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dnsIp")
    def dns_ip(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The security service DNS IP address that is used inside the
        tenant network.
        """
