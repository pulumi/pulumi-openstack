...
class SecurityServiceArgs:
    def __init__(__self__, *,
                 ...
                 dns_ip: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] type: The security service type - can either be active\\_directory,
               kerberos or ldap.  Changing this updates the existing security service.
        :param pulumi.Input[builtins.str] description: The human-readable description for the security service.
               Changing this updates the description of the existing security service.
        :param pulumi.Input[builtins.str] dns_ip: The security service DNS IP address that is used inside the
               tenant network.
        :param pulumi.Input[builtins.str] domain: The security service domain.
        :param pulumi.Input[builtins.str] name: The name of the security service. Changing this updates the name
               of the existing security service.
        :param pulumi.Input[builtins.str] ou: The security service ou. An organizational unit can be added to
               specify where the share ends up. New in Manila microversion 2.44.
        :param pulumi.Input[builtins.str] password: The user password, if you specify a user.
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V2 Shared File System client.
               ...
               security service.
        :param pulumi.Input[builtins.str] server: The security service host name or IP address.
        :param pulumi.Input[builtins.str] user: The security service user or group name that is used by the
               tenant.
        """
    ...
    def dns_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @dns_ip.setter
    def dns_ip(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SecurityServiceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ou: The security service ou. An organizational unit can be added to
               specify where the share ends up. New in Manila microversion 2.44.
        :param pulumi.Input[builtins.str] password: The user password, if you specify a user.
        :param pulumi.Input[builtins.str] project_id: The owner of the Security Service.
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V2 Shared File System client.
               A Shared File System client is needed to create a security service. If omitted, the
               `region` argument of the provider is used. Changing this creates a new
               security service.
...
class SecurityService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            server: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            user: Optional[pulumi.Input[builtins.str]] = None) -> 'SecurityService':
        """
    ...
    @property
    @pulumi.getter(name="dnsIp")
    def dns_ip(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The security service DNS IP address that is used inside the
        tenant network.
        """
