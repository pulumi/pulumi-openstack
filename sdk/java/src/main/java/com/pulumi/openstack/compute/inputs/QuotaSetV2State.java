...
public final class QuotaSetV2State extends com.pulumi.resources.ResourceArgs {

    public static final QuotaSetV2State Empty = new QuotaSetV2State();
    ...
    private QuotaSetV2State() {}

    private QuotaSetV2State(QuotaSetV2State $) {
        this.cores = $.cores;
    ...
    public static Builder builder(QuotaSetV2State defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(QuotaSetV2State defaults) {
            $ = new QuotaSetV2State(Objects.requireNonNull(defaults));
        }
