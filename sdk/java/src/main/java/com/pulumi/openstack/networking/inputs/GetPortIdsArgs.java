...
public final class GetPortIdsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetPortIdsArgs Empty = new GetPortIdsArgs();
    ...
    private GetPortIdsArgs() {}

    private GetPortIdsArgs(GetPortIdsArgs $) {
    ...
    public static Builder builder(GetPortIdsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetPortIdsArgs defaults) {
            $ = new GetPortIdsArgs(Objects.requireNonNull(defaults));
        }
