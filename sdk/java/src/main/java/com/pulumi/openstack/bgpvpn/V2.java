...
import com.pulumi.openstack.bgpvpn.inputs.V2State;
 ...
 * 
 */
@ResourceType(type="openstack:bgpvpn/v2:V2")
public class V2 extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public V2(java.lang.String name) {
        this(name, V2Args.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public V2(java.lang.String name, @Nullable V2Args args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public V2(java.lang.String name, @Nullable V2Args args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:bgpvpn/v2:V2", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private V2(java.lang.String name, Output<java.lang.String> id, @Nullable V2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:bgpvpn/v2:V2", name, state, makeResourceOptions(options, id), false);
    }

    private static V2Args makeArgs(@Nullable V2Args args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? V2Args.Empty : args;
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("openstack:index/bgpvpnV2:BgpvpnV2").build())
            ))
            .build();
     ...
     */
    public static V2 get(java.lang.String name, Output<java.lang.String> id, @Nullable V2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
