...
public final class GetContainerAclRead {
    ...
    public static final class Builder {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetContainerAclRead", "createdAt");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetContainerAclRead", "updatedAt");
            }
        ...
        public GetContainerAclRead build() {
            final var _resultValue = new GetContainerAclRead();
