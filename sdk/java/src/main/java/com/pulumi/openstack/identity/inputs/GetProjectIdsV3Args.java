...
public final class GetProjectIdsV3Args extends com.pulumi.resources.InvokeArgs {

    public static final GetProjectIdsV3Args Empty = new GetProjectIdsV3Args();
    ...
    private GetProjectIdsV3Args() {}

    private GetProjectIdsV3Args(GetProjectIdsV3Args $) {
    ...
    public static Builder builder(GetProjectIdsV3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetProjectIdsV3Args();
        }

        public Builder(GetProjectIdsV3Args defaults) {
            $ = new GetProjectIdsV3Args(Objects.requireNonNull(defaults));
        }
        ...
        public GetProjectIdsV3Args build() {
            return $;
        }
    }
