...
public final class GetSnapshotV2Args extends com.pulumi.resources.InvokeArgs {

    public static final GetSnapshotV2Args Empty = new GetSnapshotV2Args();
    ...
    private GetSnapshotV2Args() {}

    private GetSnapshotV2Args(GetSnapshotV2Args $) {
    ...
    public static Builder builder(GetSnapshotV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSnapshotV2Args();
        }

        public Builder(GetSnapshotV2Args defaults) {
            $ = new GetSnapshotV2Args(Objects.requireNonNull(defaults));
        }
