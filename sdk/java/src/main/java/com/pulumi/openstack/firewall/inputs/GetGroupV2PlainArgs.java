...
public final class GetGroupV2PlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetGroupV2PlainArgs Empty = new GetGroupV2PlainArgs();
    ...
    private GetGroupV2PlainArgs() {}

    private GetGroupV2PlainArgs(GetGroupV2PlainArgs $) {
    ...
    public static Builder builder(GetGroupV2PlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGroupV2PlainArgs();
        }

        public Builder(GetGroupV2PlainArgs defaults) {
            $ = new GetGroupV2PlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGroupV2PlainArgs build() {
            return $;
        }
    }
