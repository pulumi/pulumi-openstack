...
public final class VolumeV2State extends com.pulumi.resources.ResourceArgs {

    public static final VolumeV2State Empty = new VolumeV2State();
    ...
    private @Nullable Output<List<VolumeV2AttachmentArgs>> attachments;
     ...
     * 
     */
    public Optional<Output<List<VolumeV2AttachmentArgs>>> attachments() {
    ...
    private VolumeV2State() {}

    private VolumeV2State(VolumeV2State $) {
    ...
    public static Builder builder(VolumeV2State defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(VolumeV2State defaults) {
            $ = new VolumeV2State(Objects.requireNonNull(defaults));
        }

        /**
         * @param attachments If a volume is attached to an instance, this attribute will
         * display the Attachment ID, Instance ID, and the Device as the Instance
         * sees it.
         * 
         * @return builder
         * 
         */
        public Builder attachments(@Nullable Output<List<VolumeV2AttachmentArgs>> attachments) {
         ...
         * 
         */
        public Builder attachments(List<VolumeV2AttachmentArgs> attachments) {
         ...
         * 
         */
        public Builder attachments(VolumeV2AttachmentArgs... attachments) {
