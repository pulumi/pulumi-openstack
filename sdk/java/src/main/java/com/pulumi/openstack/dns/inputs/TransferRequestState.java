...
public final class TransferRequestState extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(TransferRequestState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransferRequestState();
        }

        public Builder(TransferRequestState defaults) {
            $ = new TransferRequestState(Objects.requireNonNull(defaults));
        }
