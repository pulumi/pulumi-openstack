...
public final class MemberV1State extends com.pulumi.resources.ResourceArgs {
    ...
    private MemberV1State(MemberV1State $) {
    ...
    public static Builder builder(MemberV1State defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(MemberV1State defaults) {
            $ = new MemberV1State(Objects.requireNonNull(defaults));
        }
