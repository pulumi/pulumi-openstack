...
public final class GetPolicyV2Args extends com.pulumi.resources.InvokeArgs {

    public static final GetPolicyV2Args Empty = new GetPolicyV2Args();
    ...
    private GetPolicyV2Args() {}

    private GetPolicyV2Args(GetPolicyV2Args $) {
    ...
    public static Builder builder(GetPolicyV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetPolicyV2Args defaults) {
            $ = new GetPolicyV2Args(Objects.requireNonNull(defaults));
        }
