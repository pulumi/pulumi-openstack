...
public final class QuotaV2State extends com.pulumi.resources.ResourceArgs {

    public static final QuotaV2State Empty = new QuotaV2State();
    ...
    private QuotaV2State() {}

    private QuotaV2State(QuotaV2State $) {
    ...
    public static Builder builder(QuotaV2State defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(QuotaV2State defaults) {
            $ = new QuotaV2State(Objects.requireNonNull(defaults));
        }
