...
public class AddressScope extends com.pulumi.resources.CustomResource {
     ...
     */
    public AddressScope(java.lang.String name) {
     ...
     */
    public AddressScope(java.lang.String name, @Nullable AddressScopeArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AddressScope(java.lang.String name, @Nullable AddressScopeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:networking/addressScope:AddressScope", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AddressScope(java.lang.String name, Output<java.lang.String> id, @Nullable AddressScopeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:networking/addressScope:AddressScope", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static AddressScope get(java.lang.String name, Output<java.lang.String> id, @Nullable AddressScopeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
