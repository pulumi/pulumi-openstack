...
public final class RuleV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(RuleV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RuleV2Args defaults) {
            $ = new RuleV2Args(Objects.requireNonNull(defaults));
        }

        /**
         * @param action Action to be taken (must be &#34;allow&#34;, &#34;deny&#34; or &#34;reject&#34;)
         * when the firewall rule matches. Changing this updates the `action` of an
         * existing firewall rule. Default is `deny`.
         * 
         * @return builder
        ...
        /**
         * @param shared Sharing status of the firewall rule (must be &#34;true&#34;
         * or &#34;false&#34; if provided). If this is &#34;true&#34; the policy is visible to, and
         * can be used in, firewalls in other tenants. Changing this updates the
         * `shared` status of an existing firewall policy. On
         * 
