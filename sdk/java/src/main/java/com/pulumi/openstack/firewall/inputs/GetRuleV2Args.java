...
public final class GetRuleV2Args extends com.pulumi.resources.InvokeArgs {

    public static final GetRuleV2Args Empty = new GetRuleV2Args();
    ...
    private GetRuleV2Args() {}

    private GetRuleV2Args(GetRuleV2Args $) {
        this.action = $.action;
    ...
    public static Builder builder(GetRuleV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetRuleV2Args defaults) {
            $ = new GetRuleV2Args(Objects.requireNonNull(defaults));
        }
