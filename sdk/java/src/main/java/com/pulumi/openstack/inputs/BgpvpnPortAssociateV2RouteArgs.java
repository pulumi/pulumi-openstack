...
public final class BgpvpnPortAssociateV2RouteArgs extends com.pulumi.resources.ResourceArgs {

    public static final BgpvpnPortAssociateV2RouteArgs Empty = new BgpvpnPortAssociateV2RouteArgs();
    ...
    private BgpvpnPortAssociateV2RouteArgs() {}

    private BgpvpnPortAssociateV2RouteArgs(BgpvpnPortAssociateV2RouteArgs $) {
    ...
    public static Builder builder(BgpvpnPortAssociateV2RouteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BgpvpnPortAssociateV2RouteArgs();
        }

        public Builder(BgpvpnPortAssociateV2RouteArgs defaults) {
            $ = new BgpvpnPortAssociateV2RouteArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BgpvpnPortAssociateV2RouteArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("BgpvpnPortAssociateV2RouteArgs", "type");
            }
            return $;
        }
    }
