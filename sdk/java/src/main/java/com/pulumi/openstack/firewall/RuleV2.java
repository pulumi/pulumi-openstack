...
public class RuleV2 extends com.pulumi.resources.CustomResource {
     ...
     */
    public RuleV2(java.lang.String name, @Nullable RuleV2Args args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RuleV2(java.lang.String name, @Nullable RuleV2Args args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:firewall/ruleV2:RuleV2", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RuleV2(java.lang.String name, Output<java.lang.String> id, @Nullable RuleV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:firewall/ruleV2:RuleV2", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static RuleV2 get(java.lang.String name, Output<java.lang.String> id, @Nullable RuleV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
