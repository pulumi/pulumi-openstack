...
public final class GetDnsZonePlainArgs extends com.pulumi.resources.InvokeArgs {
     ...
     */
    @Import(name="masters")
    private @Nullable List<String> masters;
    ...
    private @Nullable String transferredAt;
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder masters(@Nullable List<String> masters) {
            $.masters = masters;
            return this;
        }
         ...
         * 
         */
        public Builder transferredAt(@Nullable String transferredAt) {
