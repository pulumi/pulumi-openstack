...
public final class ContainerV1AclReadArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ContainerV1AclReadArgs(ContainerV1AclReadArgs $) {
    ...
    public static Builder builder(ContainerV1AclReadArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ContainerV1AclReadArgs();
        }

        public Builder(ContainerV1AclReadArgs defaults) {
            $ = new ContainerV1AclReadArgs(Objects.requireNonNull(defaults));
        }
