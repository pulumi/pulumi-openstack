...
import com.pulumi.openstack.bgpvpn.inputs.PortAssociateV2State;
import com.pulumi.openstack.bgpvpn.outputs.PortAssociateV2Route;
 ...
 * 
 */
@ResourceType(type="openstack:bgpvpn/portAssociateV2:PortAssociateV2")
public class PortAssociateV2 extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="routes", refs={List.class,PortAssociateV2Route.class}, tree="[0,1]")
    private Output</* @Nullable */ List<PortAssociateV2Route>> routes;

    /**
     * @return A list of dictionaries containing the following keys:
     * 
     */
    public Output<Optional<List<PortAssociateV2Route>>> routes() {
     ...
     */
    public PortAssociateV2(java.lang.String name) {
        this(name, PortAssociateV2Args.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public PortAssociateV2(java.lang.String name, PortAssociateV2Args args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PortAssociateV2(java.lang.String name, PortAssociateV2Args args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:bgpvpn/portAssociateV2:PortAssociateV2", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PortAssociateV2(java.lang.String name, Output<java.lang.String> id, @Nullable PortAssociateV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:bgpvpn/portAssociateV2:PortAssociateV2", name, state, makeResourceOptions(options, id), false);
    }

    private static PortAssociateV2Args makeArgs(PortAssociateV2Args args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? PortAssociateV2Args.Empty : args;
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("openstack:index/bgpvpnPortAssociateV2:BgpvpnPortAssociateV2").build())
            ))
            .build();
     ...
     */
    public static PortAssociateV2 get(java.lang.String name, Output<java.lang.String> id, @Nullable PortAssociateV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
