...
public class BgpvpnPortAssociateV2 extends com.pulumi.resources.CustomResource {
     ...
     */
    public BgpvpnPortAssociateV2(String name) {
     ...
     */
    public static BgpvpnPortAssociateV2 get(String name, Output<String> id, @Nullable BgpvpnPortAssociateV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
