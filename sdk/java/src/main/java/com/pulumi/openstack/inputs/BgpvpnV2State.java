...
public final class BgpvpnV2State extends com.pulumi.resources.ResourceArgs {

    public static final BgpvpnV2State Empty = new BgpvpnV2State();
    ...
    private BgpvpnV2State() {}

    private BgpvpnV2State(BgpvpnV2State $) {
    ...
    public static Builder builder(BgpvpnV2State defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(BgpvpnV2State defaults) {
            $ = new BgpvpnV2State(Objects.requireNonNull(defaults));
        }
