...
public final class V2Args extends com.pulumi.resources.ResourceArgs {

    public static final V2Args Empty = new V2Args();
    ...
    public static Builder builder(V2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(V2Args defaults) {
            $ = new V2Args(Objects.requireNonNull(defaults));
        }
