...
public class GroupV2 extends com.pulumi.resources.CustomResource {
     ...
     */
    public GroupV2(java.lang.String name, @Nullable GroupV2Args args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public GroupV2(java.lang.String name, @Nullable GroupV2Args args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:firewall/groupV2:GroupV2", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private GroupV2(java.lang.String name, Output<java.lang.String> id, @Nullable GroupV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:firewall/groupV2:GroupV2", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static GroupV2 get(java.lang.String name, Output<java.lang.String> id, @Nullable GroupV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
