...
public final class BgpvpnPortAssociateV2Args extends com.pulumi.resources.ResourceArgs {

    public static final BgpvpnPortAssociateV2Args Empty = new BgpvpnPortAssociateV2Args();
    ...
    private BgpvpnPortAssociateV2Args() {}

    private BgpvpnPortAssociateV2Args(BgpvpnPortAssociateV2Args $) {
    ...
    public static Builder builder(BgpvpnPortAssociateV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BgpvpnPortAssociateV2Args();
        }

        public Builder(BgpvpnPortAssociateV2Args defaults) {
            $ = new BgpvpnPortAssociateV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public BgpvpnPortAssociateV2Args build() {
            if ($.bgpvpnId == null) {
                throw new MissingRequiredPropertyException("BgpvpnPortAssociateV2Args", "bgpvpnId");
            }
            if ($.portId == null) {
                throw new MissingRequiredPropertyException("BgpvpnPortAssociateV2Args", "portId");
            }
            return $;
        }
    }
