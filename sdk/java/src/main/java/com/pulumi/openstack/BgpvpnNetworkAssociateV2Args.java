...
public final class BgpvpnNetworkAssociateV2Args extends com.pulumi.resources.ResourceArgs {

    public static final BgpvpnNetworkAssociateV2Args Empty = new BgpvpnNetworkAssociateV2Args();
    ...
    private BgpvpnNetworkAssociateV2Args() {}

    private BgpvpnNetworkAssociateV2Args(BgpvpnNetworkAssociateV2Args $) {
    ...
    public static Builder builder(BgpvpnNetworkAssociateV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BgpvpnNetworkAssociateV2Args();
        }

        public Builder(BgpvpnNetworkAssociateV2Args defaults) {
            $ = new BgpvpnNetworkAssociateV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public BgpvpnNetworkAssociateV2Args build() {
            if ($.bgpvpnId == null) {
                throw new MissingRequiredPropertyException("BgpvpnNetworkAssociateV2Args", "bgpvpnId");
            }
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("BgpvpnNetworkAssociateV2Args", "networkId");
            }
            return $;
        }
    }
