...
public class BgpvpnV2 extends com.pulumi.resources.CustomResource {
     ...
     */
    public BgpvpnV2(java.lang.String name) {
     ...
     */
    public BgpvpnV2(java.lang.String name, @Nullable BgpvpnV2Args args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public BgpvpnV2(java.lang.String name, @Nullable BgpvpnV2Args args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:index/bgpvpnV2:BgpvpnV2", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private BgpvpnV2(java.lang.String name, Output<java.lang.String> id, @Nullable BgpvpnV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:index/bgpvpnV2:BgpvpnV2", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static BgpvpnV2 get(java.lang.String name, Output<java.lang.String> id, @Nullable BgpvpnV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
