...
public final class QuoteSetV3Args extends com.pulumi.resources.ResourceArgs {
    ...
    private QuoteSetV3Args(QuoteSetV3Args $) {
    ...
    public static Builder builder(QuoteSetV3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(QuoteSetV3Args defaults) {
            $ = new QuoteSetV3Args(Objects.requireNonNull(defaults));
        }
