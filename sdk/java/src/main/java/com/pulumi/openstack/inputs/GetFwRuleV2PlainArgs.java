...
public final class GetFwRuleV2PlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetFwRuleV2PlainArgs(GetFwRuleV2PlainArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(GetFwRuleV2PlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFwRuleV2PlainArgs();
        }

        public Builder(GetFwRuleV2PlainArgs defaults) {
            $ = new GetFwRuleV2PlainArgs(Objects.requireNonNull(defaults));
        }
