...
public final class RuleV2State extends com.pulumi.resources.ResourceArgs {
    ...
    public static final RuleV2State Empty = new RuleV2State();
    ...
    private RuleV2State(RuleV2State $) {
        this.action = $.action;
    ...
    public static Builder builder(RuleV2State defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RuleV2State defaults) {
            $ = new RuleV2State(Objects.requireNonNull(defaults));
        }
