...
public class FloatingIpAssociate extends com.pulumi.resources.CustomResource {
    ...
    public FloatingIpAssociate(java.lang.String name, FloatingIpAssociateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:networking/floatingIpAssociate:FloatingIpAssociate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private FloatingIpAssociate(java.lang.String name, Output<java.lang.String> id, @Nullable FloatingIpAssociateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:networking/floatingIpAssociate:FloatingIpAssociate", name, state, makeResourceOptions(options, id), false);
    }
