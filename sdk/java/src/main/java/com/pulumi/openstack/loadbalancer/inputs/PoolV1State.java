...
public final class PoolV1State extends com.pulumi.resources.ResourceArgs {

    public static final PoolV1State Empty = new PoolV1State();
    ...
    public static Builder builder(PoolV1State defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PoolV1State defaults) {
            $ = new PoolV1State(Objects.requireNonNull(defaults));
        }
