...
public final class ClusterTemplateState extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="coe")
    private @Nullable Output<String> coe;
     ...
     * 
     */
    public Optional<Output<String>> coe() {
        return Optional.ofNullable(this.coe);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder coe(@Nullable Output<String> coe) {
            $.coe = coe;
            return this;
        }
        ...
        /**
         * @param projectId The project of the cluster template. Required if
         * admin wants to create a cluster template in another project. Changing this
         * creates a new cluster template.
         * 
         * @return builder
        ...
        /**
         * @param userId The user of the cluster template. Required if admin
         * wants to create a cluster template for another user. Changing this creates
         * a new cluster template.
         * 
         * @return builder
