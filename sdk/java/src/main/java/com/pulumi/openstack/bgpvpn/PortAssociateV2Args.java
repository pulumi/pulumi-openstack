...
public final class PortAssociateV2Args extends com.pulumi.resources.ResourceArgs {

    public static final PortAssociateV2Args Empty = new PortAssociateV2Args();
    ...
    private PortAssociateV2Args() {}

    private PortAssociateV2Args(PortAssociateV2Args $) {
    ...
    public static Builder builder(PortAssociateV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PortAssociateV2Args();
        }

        public Builder(PortAssociateV2Args defaults) {
            $ = new PortAssociateV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public PortAssociateV2Args build() {
            if ($.bgpvpnId == null) {
                throw new MissingRequiredPropertyException("PortAssociateV2Args", "bgpvpnId");
            }
            if ($.portId == null) {
                throw new MissingRequiredPropertyException("PortAssociateV2Args", "portId");
            }
            return $;
        }
    }
