...
public class BgpvpnRouterAssociateV2 extends com.pulumi.resources.CustomResource {
     ...
     */
    public BgpvpnRouterAssociateV2(java.lang.String name) {
     ...
     */
    public BgpvpnRouterAssociateV2(java.lang.String name, BgpvpnRouterAssociateV2Args args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public BgpvpnRouterAssociateV2(java.lang.String name, BgpvpnRouterAssociateV2Args args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:index/bgpvpnRouterAssociateV2:BgpvpnRouterAssociateV2", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private BgpvpnRouterAssociateV2(java.lang.String name, Output<java.lang.String> id, @Nullable BgpvpnRouterAssociateV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:index/bgpvpnRouterAssociateV2:BgpvpnRouterAssociateV2", name, state, makeResourceOptions(options, id), false);
    }

    private static BgpvpnRouterAssociateV2Args makeArgs(BgpvpnRouterAssociateV2Args args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? BgpvpnRouterAssociateV2Args.Empty : args;
    }
     ...
     */
    public static BgpvpnRouterAssociateV2 get(java.lang.String name, Output<java.lang.String> id, @Nullable BgpvpnRouterAssociateV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
