...
public class VolumeAttachV2 extends com.pulumi.resources.CustomResource {
     ...
     */
    public VolumeAttachV2(java.lang.String name, VolumeAttachV2Args args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VolumeAttachV2(java.lang.String name, VolumeAttachV2Args args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:blockstorage/volumeAttachV2:VolumeAttachV2", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VolumeAttachV2(java.lang.String name, Output<java.lang.String> id, @Nullable VolumeAttachV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("openstack:blockstorage/volumeAttachV2:VolumeAttachV2", name, state, makeResourceOptions(options, id), false);
    }

    private static VolumeAttachV2Args makeArgs(VolumeAttachV2Args args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? VolumeAttachV2Args.Empty : args;
    }
     ...
     */
    public static VolumeAttachV2 get(java.lang.String name, Output<java.lang.String> id, @Nullable VolumeAttachV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
