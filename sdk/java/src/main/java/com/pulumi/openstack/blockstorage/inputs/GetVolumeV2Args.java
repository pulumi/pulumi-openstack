...
public final class GetVolumeV2Args extends com.pulumi.resources.InvokeArgs {
    ...
    private GetVolumeV2Args(GetVolumeV2Args $) {
    ...
    public static Builder builder(GetVolumeV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetVolumeV2Args defaults) {
            $ = new GetVolumeV2Args(Objects.requireNonNull(defaults));
        }
