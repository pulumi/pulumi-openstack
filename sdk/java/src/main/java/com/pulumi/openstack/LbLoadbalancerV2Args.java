...
public final class LbLoadbalancerV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    private LbLoadbalancerV2Args() {}

    private LbLoadbalancerV2Args(LbLoadbalancerV2Args $) {
    ...
    public static Builder builder(LbLoadbalancerV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LbLoadbalancerV2Args defaults) {
            $ = new LbLoadbalancerV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LbLoadbalancerV2Args build() {
            return $;
        }
    }
