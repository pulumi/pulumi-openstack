...
export class ContainerObject extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly date: pulumi.Output<string>;
    /**
     * An integer representing the number of seconds after which the
     * system removes the object. Internally, the Object Storage system stores this value in
     * the X-Delete-At metadata item.
     */
    declare public readonly deleteAfter: pulumi.Output<number | undefined>;
    /**
     * An string representing the date when the system removes the object.
     * For example, "2015-08-26" is equivalent to Mon, Wed, 26 Aug 2015 00:00:00 GMT.
     */
    declare public readonly deleteAt: pulumi.Output<string>;
    /**
     * If set to true, Object Storage guesses the content
     * type based on the file extension and ignores the value sent in the Content-Type
     * header, if present.
     */
    declare public readonly detectContentType: pulumi.Output<boolean | undefined>;
    /**
     ...
     * header.
     */
    declare public readonly objectManifest: pulumi.Output<string>;
    /**
     ...
     */
    declare public /*out*/ readonly transId: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: ContainerObjectArgs | ContainerObjectState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["deleteAfter"] = state?.deleteAfter;
            resourceInputs["deleteAt"] = state?.deleteAt;
            resourceInputs["detectContentType"] = state?.detectContentType;
            resourceInputs["etag"] = state?.etag;
            resourceInputs["lastModified"] = state?.lastModified;
            resourceInputs["metadata"] = state?.metadata;
            resourceInputs["name"] = state?.name;
            resourceInputs["objectManifest"] = state?.objectManifest;
            resourceInputs["region"] = state?.region;
            resourceInputs["source"] = state?.source;
            resourceInputs["transId"] = state?.transId;
        } else {
            ...
            resourceInputs["deleteAfter"] = args?.deleteAfter;
            resourceInputs["deleteAt"] = args?.deleteAt;
            resourceInputs["detectContentType"] = args?.detectContentType;
            resourceInputs["etag"] = args?.etag;
            resourceInputs["metadata"] = args?.metadata;
            resourceInputs["name"] = args?.name;
            resourceInputs["objectManifest"] = args?.objectManifest;
...
export interface ContainerObjectState {
     ...
     * For example, "2015-08-26" is equivalent to Mon, Wed, 26 Aug 2015 00:00:00 GMT.
     */
    deleteAt?: pulumi.Input<string | undefined>;
    /**
     * If set to true, Object Storage guesses the content
     * type based on the file extension and ignores the value sent in the Content-Type
     * header, if present.
     */
    detectContentType?: pulumi.Input<boolean | undefined>;
    /**
     * Used to trigger updates. The only meaningful value is ${md5(file("path/to/file"))}.
     */
     ...
     * header.
     */
    objectManifest?: pulumi.Input<string | undefined>;
    /**
     * The region in which to create the container. If
     * omitted, the `region` argument of the provider is used. Changing this
     * creates a new container.
     ...
     * need this value if you report a problem.
     */
    transId?: pulumi.Input<string | undefined>;
}
