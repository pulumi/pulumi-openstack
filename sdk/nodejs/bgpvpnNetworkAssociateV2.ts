 ...
 * ```
 */
export class BgpvpnNetworkAssociateV2 extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BgpvpnNetworkAssociateV2State, opts?: pulumi.CustomResourceOptions): BgpvpnNetworkAssociateV2 {
        return new BgpvpnNetworkAssociateV2(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'openstack:index/bgpvpnNetworkAssociateV2:BgpvpnNetworkAssociateV2';

    /**
     * Returns true if the given object is an instance of BgpvpnNetworkAssociateV2.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is BgpvpnNetworkAssociateV2 {
    ...
    constructor(name: string, argsOrState?: BgpvpnNetworkAssociateV2Args | BgpvpnNetworkAssociateV2State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as BgpvpnNetworkAssociateV2State | undefined;
            resourceInputs["bgpvpnId"] = state ? state.bgpvpnId : undefined;
            resourceInputs["networkId"] = state ? state.networkId : undefined;
            resourceInputs["projectId"] = state ? state.projectId : undefined;
            resourceInputs["region"] = state ? state.region : undefined;
        } else {
            const args = argsOrState as BgpvpnNetworkAssociateV2Args | undefined;
