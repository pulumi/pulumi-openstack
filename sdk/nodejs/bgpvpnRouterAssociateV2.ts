...
export class BgpvpnRouterAssociateV2 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'openstack:index/bgpvpnRouterAssociateV2:BgpvpnRouterAssociateV2';

    /**
     * Returns true if the given object is an instance of BgpvpnRouterAssociateV2.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is BgpvpnRouterAssociateV2 {
    ...
    constructor(name: string, argsOrState?: BgpvpnRouterAssociateV2Args | BgpvpnRouterAssociateV2State, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as BgpvpnRouterAssociateV2State | undefined;
            ...
            const args = argsOrState as BgpvpnRouterAssociateV2Args | undefined;
