 ...
 */
export declare function createFunctionInfoAsync(func: Function, serialize: (o: any) => boolean): Promise<FunctionInfo>;
export declare function isLegalMemberName(n: string): boolean;
export declare function isLegalFunctionName(n: string): boolean;
