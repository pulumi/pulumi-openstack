...
`,
    });
    {
        ...
        cases.push({
            ...
            expectText: undefined,
            error: `Error serializing '() => os': closure.spec.js(0,0)
...
Consider using import('os') or require('os') inside '(a, b, c) => { const v = os; ...': closure.spec.js(0,0)`,
    ...
    }
    {
        ...
        cases.push({
            ...
            func: func,
            expectText: undefined,
            error: `Error serializing '() => handler': closure.spec.js(0,0)
...
Consider using import('os') or require('os') inside '() => os': closure.spec.js(0,0)`,
    ...
    }
    {
        ...
        cases.push({
            ...
            func: () => util,
            expectText: undefined,
            error: `Error serializing '() => util': closure.spec.js(0,0)
...
`,
    ...
    while (true) {
        ...
        it(test.title, util_1.asyncTest(() => __awaiter(this, void 0, void 0, function* () {
            ...
            if (test.expectText) {
                const sf = yield index_1.runtime.serializeFunction(test.func);
                ...
                const message = yield util_1.assertAsyncThrows(() => __awaiter(this, void 0, void 0, function* () {
                    yield index_1.runtime.serializeFunction(test.func);
                }));
 ...
 */
function compareErrorText(expected, actual) {
    const wildcard = "(...)";
