            ...
            for (const dryrun of [true, false]) {
                ...
                (call, callback) => {
                    ...
                    if (opts.invoke) {
                        ...
                        const { failures, ret } = opts.invoke(ctx, req.getTok(), args);
                ...
                (call, callback) => {
                    ...
                    if (req.getType() !== index_1.runtime.rootPulumiStackTypeName) {
...
function createMockResourceMonitor(invokeCallback, readResourceCallback, registerResourceCallback, registerResourceOutputsCallback) {
