...
namespace Pulumi.Openstack.Sharedfilesystem
{
    ...
    public partial class Share : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.ShareExportLocations>> ExportLocations { get; private set; } = null!;
        ...
        public Share(string name, ShareArgs args, CustomResourceOptions? options = null)
            : base("openstack:sharedfilesystem/share:Share", name, args ?? ResourceArgs.Empty, MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class ShareState : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.ShareExportLocationsGetArgs>? _exportLocations;

        /// <summary>
        /// A list of export locations. For example, when a share server
        /// has more than one network interface, it can have multiple export locations.
        /// </summary>
        public InputList<Inputs.ShareExportLocationsGetArgs> ExportLocations
        {
            get => _exportLocations ?? (_exportLocations = new InputList<Inputs.ShareExportLocationsGetArgs>());
    ...
    public sealed class ShareExportLocationsGetArgs : Pulumi.ResourceArgs
    {
        [Input("path")]
        ...
        public ShareExportLocationsGetArgs()
        {
        }
    }
    }
    ...
    [OutputType]
    public sealed class ShareExportLocations
    {
        public readonly string Path;
        public readonly string Preferred;

        [OutputConstructor]
        private ShareExportLocations(
            string path,
            string preferred)
        {
            Path = path;
