...
namespace Pulumi.OpenStack.KeyManager
{
    ...
    {
        [Input("read")]
        public Input<SecretV1AclReadArgs>? Read { get; set; }
    ...
    {
        [Input("read")]
        public Input<SecretV1AclReadGetArgs>? Read { get; set; }
    ...
    {
        public readonly SecretV1AclRead Read;

        [OutputConstructor]
        private SecretV1Acl(SecretV1AclRead read)
        {
            Read = read;
        }
    }
