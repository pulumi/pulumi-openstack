...
namespace Pulumi.OpenStack.BlockStorage
{
    ...
    public partial class VolumeV2 : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("attachments")]
        public Output<ImmutableArray<Outputs.VolumeV2Attachment>> Attachments { get; private set; } = null!;
        ...
        public VolumeV2(string name, VolumeV2Args args, CustomResourceOptions? options = null)
            : base("openstack:blockstorage/volumeV2:VolumeV2", name, args ?? new VolumeV2Args(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class VolumeV2Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The availability zone for the volume.
        /// Changing this creates a new volume.
        ...
        public static new VolumeV2Args Empty => new VolumeV2Args();
    }

    public sealed class VolumeV2State : global::Pulumi.ResourceArgs
    {
        [Input("attachments")]
        private InputList<Inputs.VolumeV2AttachmentGetArgs>? _attachments;
        ...
        /// sees it.
        /// </summary>
        public InputList<Inputs.VolumeV2AttachmentGetArgs> Attachments
        {
            get => _attachments ?? (_attachments = new InputList<Inputs.VolumeV2AttachmentGetArgs>());
        ...
        public static new VolumeV2State Empty => new VolumeV2State();
    }
}
