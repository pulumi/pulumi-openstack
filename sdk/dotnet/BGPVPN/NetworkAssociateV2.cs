...
namespace Pulumi.OpenStack.BGPVPN
{
    ...
    /// ```
    /// </summary>
    [OpenStackResourceType("openstack:bgpvpn/networkAssociateV2:NetworkAssociateV2")]
    public partial class NetworkAssociateV2 : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public NetworkAssociateV2(string name, NetworkAssociateV2Args args, CustomResourceOptions? options = null)
            : base("openstack:bgpvpn/networkAssociateV2:NetworkAssociateV2", name, args ?? new NetworkAssociateV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkAssociateV2(string name, Input<string> id, NetworkAssociateV2State? state = null, CustomResourceOptions? options = null)
            : base("openstack:bgpvpn/networkAssociateV2:NetworkAssociateV2", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "openstack:index/bgpvpnNetworkAssociateV2:BgpvpnNetworkAssociateV2" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NetworkAssociateV2 Get(string name, Input<string> id, NetworkAssociateV2State? state = null, CustomResourceOptions? options = null)
        {
            return new NetworkAssociateV2(name, id, state, options);
        }
    }

    public sealed class NetworkAssociateV2Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The ID of the BGP VPN to which the network will be
        /// associated. Changing this creates a new BGP VPN network association
        ...
        public NetworkAssociateV2Args()
        {
        }
        public static new NetworkAssociateV2Args Empty => new NetworkAssociateV2Args();
    }

    public sealed class NetworkAssociateV2State : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The ID of the BGP VPN to which the network will be
        /// associated. Changing this creates a new BGP VPN network association
        ...
        public NetworkAssociateV2State()
        {
        }
        public static new NetworkAssociateV2State Empty => new NetworkAssociateV2State();
    }
}
