...
namespace Pulumi.OpenStack.Compute.Outputs
{
    ...
    [OutputType]
    public sealed class VolumeAttachVendorOptions
    {
        /// <summary>
        ...
        /// </summary>
        public readonly bool? IgnoreVolumeConfirmation;

        [OutputConstructor]
        private VolumeAttachVendorOptions(bool? ignoreVolumeConfirmation)
        {
