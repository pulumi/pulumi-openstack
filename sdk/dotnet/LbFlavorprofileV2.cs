...
namespace Pulumi.OpenStack
{
    ...
    public partial class LbFlavorprofileV2 : global::Pulumi.CustomResource
    {
        ...
        public LbFlavorprofileV2(string name, LbFlavorprofileV2Args args, CustomResourceOptions? options = null)
            : base("openstack:index/lbFlavorprofileV2:LbFlavorprofileV2", name, args ?? new LbFlavorprofileV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private LbFlavorprofileV2(string name, Input<string> id, LbFlavorprofileV2State? state = null, CustomResourceOptions? options = null)
            : base("openstack:index/lbFlavorprofileV2:LbFlavorprofileV2", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LbFlavorprofileV2 Get(string name, Input<string> id, LbFlavorprofileV2State? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class LbFlavorprofileV2Args : global::Pulumi.ResourceArgs
    {
        ...
        public LbFlavorprofileV2Args()
        {
        }
        public static new LbFlavorprofileV2Args Empty => new LbFlavorprofileV2Args();
    }
    ...
    public sealed class LbFlavorprofileV2State : global::Pulumi.ResourceArgs
    {
        ...
        public LbFlavorprofileV2State()
        {
        }
        public static new LbFlavorprofileV2State Empty => new LbFlavorprofileV2State();
    }
}
